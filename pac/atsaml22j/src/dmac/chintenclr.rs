...
pub type TERR_W<'a, const O: u8> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, O>;
...
pub type TCMPL_W<'a, const O: u8> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, O>;
...
pub type SUSP_W<'a, const O: u8> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, O>;
impl R {
