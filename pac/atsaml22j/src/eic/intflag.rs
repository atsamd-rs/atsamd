...
#[doc = "Field `EXTINT` reader - External Interrupt Flag"]
pub type EXTINT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `EXTINT` writer - External Interrupt Flag"]
pub type EXTINT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INTFLAG_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - External Interrupt Flag"]
    #[inline(always)]
