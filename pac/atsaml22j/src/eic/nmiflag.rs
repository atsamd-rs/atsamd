...
#[doc = "Field `NMI` reader - NMI Interrupt Flag"]
pub type NMI_R = crate::BitReader<bool>;
#[doc = "Field `NMI` writer - NMI Interrupt Flag"]
pub type NMI_W<'a, const O: u8> = crate::BitWriter<'a, u16, NMIFLAG_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - NMI Interrupt Flag"]
    #[inline(always)]
