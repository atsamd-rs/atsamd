...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn dacctrl(&self, n: usize) -> &Dacctrl {
        &self.dacctrl[n]
    }
    ...
    #[inline(always)]
    pub const fn databuf(&self, n: usize) -> &Databuf {
        &self.databuf[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x14 - DAC n Data Buffer"]
