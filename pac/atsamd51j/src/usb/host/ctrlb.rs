...
pub type AUTORESUME_R = crate::BitReader;
#[doc = "Field `AUTORESUME` writer - Auto Resume Enable"]
pub type AUTORESUME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn autoresume(&mut self) -> AUTORESUME_W<CTRLB_SPEC, 4> {
