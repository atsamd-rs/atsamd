...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suspend(&mut self) -> SUSPEND_W<INTENCLR_SPEC, 0> {
        SUSPEND_W::new(self)
    }
    #[doc = "Bit 1 - Micro Start of Frame Interrupt Enable in High Speed Mode"]
    #[inline(always)]
    #[must_use]
    pub fn msof(&mut self) -> MSOF_W<INTENCLR_SPEC, 1> {
        MSOF_W::new(self)
    }
    #[doc = "Bit 2 - Start Of Frame Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sof(&mut self) -> SOF_W<INTENCLR_SPEC, 2> {
        SOF_W::new(self)
    }
    #[doc = "Bit 3 - End of Reset Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eorst(&mut self) -> EORST_W<INTENCLR_SPEC, 3> {
        EORST_W::new(self)
    }
    #[doc = "Bit 4 - Wake Up Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn eorsm(&mut self) -> EORSM_W<INTENCLR_SPEC, 5> {
        EORSM_W::new(self)
    }
    #[doc = "Bit 6 - Upstream Resume Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpmnyet(&mut self) -> LPMNYET_W<INTENCLR_SPEC, 8> {
        LPMNYET_W::new(self)
    }
    #[doc = "Bit 9 - Link Power Management Suspend Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lpmsusp(&mut self) -> LPMSUSP_W<INTENCLR_SPEC, 9> {
        LPMSUSP_W::new(self)
    }
