...
pub type FINE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFLLVAL_SPEC, u8, u8, 8, O>;
...
pub type DIFF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFLLVAL_SPEC, u16, u16, 16, O>;
impl R {
