...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sense0(&mut self) -> Sense0W<Config0Spec> {
        Sense0W::new(self, 0)
    }
    #[doc = "Bit 3 - Filter Enable 0"]
    #[inline(always)]
    #[must_use]
    pub fn filten0(&mut self) -> Filten0W<Config0Spec> {
        Filten0W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Input Sense Configuration 1"]
    #[inline(always)]
    #[must_use]
    pub fn sense1(&mut self) -> Sense1W<Config0Spec> {
        Sense1W::new(self, 4)
    }
    #[doc = "Bit 7 - Filter Enable 1"]
    #[inline(always)]
    #[must_use]
    pub fn filten1(&mut self) -> Filten1W<Config0Spec> {
        Filten1W::new(self, 7)
    }
    #[doc = "Bits 8:10 - Input Sense Configuration 2"]
    #[inline(always)]
    #[must_use]
    pub fn sense2(&mut self) -> Sense2W<Config0Spec> {
        Sense2W::new(self, 8)
    }
    #[doc = "Bit 11 - Filter Enable 2"]
    #[inline(always)]
    #[must_use]
    pub fn filten2(&mut self) -> Filten2W<Config0Spec> {
        Filten2W::new(self, 11)
    }
    #[doc = "Bits 12:14 - Input Sense Configuration 3"]
    #[inline(always)]
    #[must_use]
    pub fn sense3(&mut self) -> Sense3W<Config0Spec> {
        Sense3W::new(self, 12)
    }
    #[doc = "Bit 15 - Filter Enable 3"]
    #[inline(always)]
    #[must_use]
    pub fn filten3(&mut self) -> Filten3W<Config0Spec> {
        Filten3W::new(self, 15)
    }
    #[doc = "Bits 16:18 - Input Sense Configuration 4"]
    #[inline(always)]
    #[must_use]
    pub fn sense4(&mut self) -> Sense4W<Config0Spec> {
        Sense4W::new(self, 16)
    }
    #[doc = "Bit 19 - Filter Enable 4"]
    #[inline(always)]
    #[must_use]
    pub fn filten4(&mut self) -> Filten4W<Config0Spec> {
        Filten4W::new(self, 19)
    }
    #[doc = "Bits 20:22 - Input Sense Configuration 5"]
    #[inline(always)]
    #[must_use]
    pub fn sense5(&mut self) -> Sense5W<Config0Spec> {
        Sense5W::new(self, 20)
    }
    #[doc = "Bit 23 - Filter Enable 5"]
    #[inline(always)]
    #[must_use]
    pub fn filten5(&mut self) -> Filten5W<Config0Spec> {
        Filten5W::new(self, 23)
    }
    #[doc = "Bits 24:26 - Input Sense Configuration 6"]
    #[inline(always)]
    #[must_use]
    pub fn sense6(&mut self) -> Sense6W<Config0Spec> {
        Sense6W::new(self, 24)
    }
    #[doc = "Bit 27 - Filter Enable 6"]
    #[inline(always)]
    #[must_use]
    pub fn filten6(&mut self) -> Filten6W<Config0Spec> {
        Filten6W::new(self, 27)
    }
    #[doc = "Bits 28:30 - Input Sense Configuration 7"]
    #[inline(always)]
    #[must_use]
    pub fn sense7(&mut self) -> Sense7W<Config0Spec> {
        Sense7W::new(self, 28)
    }
    #[doc = "Bit 31 - Filter Enable 7"]
    #[inline(always)]
    #[must_use]
    pub fn filten7(&mut self) -> Filten7W<Config0Spec> {
