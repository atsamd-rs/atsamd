...
pub enum Cmdselect {
    ...
    Cbpdis = 27,
    #[doc = "28: Set Chip Erase Hard Lock - DSU.CTRL.CE command is not available"]
    Scehl = 28,
    #[doc = "29: Set Boot Protect Hard Lock"]
    Sbphl = 29,
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Set Chip Erase Hard Lock - DSU.CTRL.CE command is not available"]
    #[inline(always)]
    pub fn scehl(self) -> &'a mut crate::W<REG> {
        self.variant(Cmdselect::Scehl)
    }
    #[doc = "Set Boot Protect Hard Lock"]
    #[inline(always)]
    pub fn sbphl(self) -> &'a mut crate::W<REG> {
        self.variant(Cmdselect::Sbphl)
    }
