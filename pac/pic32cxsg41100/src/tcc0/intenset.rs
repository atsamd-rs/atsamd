...
pub type OvfW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type UfsW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type DfsW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type FaultaW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type FaultbW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Fault0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Fault1W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc1W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc2W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc3W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc4W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Mc5W<'a, REG> = crate::BitWriter1S<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trg(&mut self) -> TrgW<IntensetSpec> {
        TrgW::new(self, 1)
    }
    #[doc = "Bit 2 - Counter Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<IntensetSpec> {
        CntW::new(self, 2)
    }
    #[doc = "Bit 3 - Error Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ufs(&mut self) -> UfsW<IntensetSpec> {
        UfsW::new(self, 10)
    }
    #[doc = "Bit 11 - Non-Recoverable Debug Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfs(&mut self) -> DfsW<IntensetSpec> {
        DfsW::new(self, 11)
    }
    #[doc = "Bit 12 - Recoverable Fault A Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn faulta(&mut self) -> FaultaW<IntensetSpec> {
        FaultaW::new(self, 12)
    }
    #[doc = "Bit 13 - Recoverable Fault B Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn faultb(&mut self) -> FaultbW<IntensetSpec> {
        FaultbW::new(self, 13)
    }
    #[doc = "Bit 14 - Non-Recoverable Fault 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fault0(&mut self) -> Fault0W<IntensetSpec> {
        Fault0W::new(self, 14)
    }
    #[doc = "Bit 15 - Non-Recoverable Fault 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fault1(&mut self) -> Fault1W<IntensetSpec> {
        Fault1W::new(self, 15)
    }
    #[doc = "Bit 16 - Match or Capture Channel 0 Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mc2(&mut self) -> Mc2W<IntensetSpec> {
        Mc2W::new(self, 18)
    }
    #[doc = "Bit 19 - Match or Capture Channel 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc3(&mut self) -> Mc3W<IntensetSpec> {
        Mc3W::new(self, 19)
    }
    #[doc = "Bit 20 - Match or Capture Channel 4 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc4(&mut self) -> Mc4W<IntensetSpec> {
        Mc4W::new(self, 20)
    }
    #[doc = "Bit 21 - Match or Capture Channel 5 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc5(&mut self) -> Mc5W<IntensetSpec> {
        Mc5W::new(self, 21)
    }
}
...
impl crate::Writable for IntensetSpec {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x003f_fc0f;
}
