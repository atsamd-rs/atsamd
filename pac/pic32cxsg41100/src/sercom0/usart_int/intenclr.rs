...
pub type RxsW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type CtsicW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type RxbrkW<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxs(&mut self) -> RxsW<IntenclrSpec> {
        RxsW::new(self, 3)
    }
    #[doc = "Bit 4 - Clear To Send Input Change Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn ctsic(&mut self) -> CtsicW<IntenclrSpec> {
        CtsicW::new(self, 4)
    }
    #[doc = "Bit 5 - Break Received Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn rxbrk(&mut self) -> RxbrkW<IntenclrSpec> {
        RxbrkW::new(self, 5)
    }
    #[doc = "Bit 7 - Combined Error Interrupt Disable"]
    #[inline(always)]
