...
impl TRIGSRC_R {
    ...
    pub fn variant(&self) -> Option<TRIGSRC_A> {
        match self.bits {
            ...
            7 => Some(TRIGSRC_A::TCC0_OVF),
            8 => Some(TRIGSRC_A::TCC0_MC0),
            9 => Some(TRIGSRC_A::TCC0_MC1),
            10 => Some(TRIGSRC_A::TCC0_MC2),
            11 => Some(TRIGSRC_A::TCC0_MC3),
            12 => Some(TRIGSRC_A::TC1_OVF),
            13 => Some(TRIGSRC_A::TC1_MC0),
            14 => Some(TRIGSRC_A::TC1_MC1),
            15 => Some(TRIGSRC_A::TC2_OVF),
            16 => Some(TRIGSRC_A::TC2_MC0),
            17 => Some(TRIGSRC_A::TC2_MC1),
            18 => Some(TRIGSRC_A::ADC_RESRDY),
            19 => Some(TRIGSRC_A::DAC_EMPTY),
            _ => None,
        }
    }
