...
impl Peripherals {
    ...
    #[doc = " Unchecked version of `Peripherals::take`."]
    #[doc = ""]
    #[doc = " # Safety"]
    #[doc = ""]
    #[doc = " Each of the returned peripherals must be used at most once."]
    #[inline]
