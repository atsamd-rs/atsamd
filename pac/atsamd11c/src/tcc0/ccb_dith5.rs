...
pub type R = crate::R<CCB_DITH5_SPEC>;
#[doc = "Register `CCB%s_DITH5` writer"]
pub type W = crate::W<CCB_DITH5_SPEC>;
...
pub type CCB_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 19, O, u32>;
impl R {
    ...
    pub fn ccb(&self) -> CCB_R {
        CCB_R::new((self.bits >> 5) & 0x0007_ffff)
    }
}
impl W {
    #[doc = "Bits 0:4 - Dithering Buffer Cycle Number"]
    #[inline(always)]
    #[must_use]
    pub fn dithercyb(&mut self) -> DITHERCYB_W<CCB_DITH5_SPEC, 0> {
        DITHERCYB_W::new(self)
    }
    #[doc = "Bits 5:23 - Channel Compare/Capture Buffer Value"]
    #[inline(always)]
    #[must_use]
    pub fn ccb(&mut self) -> CCB_W<CCB_DITH5_SPEC, 5> {
        CCB_W::new(self)
    }
