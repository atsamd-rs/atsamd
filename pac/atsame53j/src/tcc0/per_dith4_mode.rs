#[doc = "Reader of register PER_DITH4_MODE"]
pub type R = crate::R<u32, super::PER_DITH4_MODE>;
#[doc = "Writer for register PER_DITH4_MODE"]
pub type W = crate::W<u32, super::PER_DITH4_MODE>;
#[doc = "Register PER_DITH4_MODE `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::PER_DITH4_MODE {
    type Type = u32;
    #[inline(always)]
