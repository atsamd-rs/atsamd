...
pub type R = crate::R<BAUD_FRACFP_MODE_SPEC>;
#[doc = "Register `BAUD_FRACFP_MODE` writer"]
pub type W = crate::W<BAUD_FRACFP_MODE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn baud(&mut self) -> BAUD_W<BAUD_FRACFP_MODE_SPEC, 0> {
        BAUD_W::new(self)
    }
    #[doc = "Bits 13:15 - Fractional Part"]
    #[inline(always)]
    #[must_use]
    pub fn fp(&mut self) -> FP_W<BAUD_FRACFP_MODE_SPEC, 13> {
        FP_W::new(self)
    }
