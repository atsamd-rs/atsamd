#[doc = "Reader of register PERBUF_DITH4"]
pub type R = crate::R<u32, super::PERBUF_DITH4>;
#[doc = "Writer for register PERBUF_DITH4"]
pub type W = crate::W<u32, super::PERBUF_DITH4>;
#[doc = "Register PERBUF_DITH4 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::PERBUF_DITH4 {
    type Type = u32;
    #[inline(always)]
