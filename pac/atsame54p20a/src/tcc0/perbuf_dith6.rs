#[doc = "Reader of register PERBUF_DITH6"]
pub type R = crate::R<u32, super::PERBUF_DITH6>;
#[doc = "Writer for register PERBUF_DITH6"]
pub type W = crate::W<u32, super::PERBUF_DITH6>;
#[doc = "Register PERBUF_DITH6 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::PERBUF_DITH6 {
    type Type = u32;
    #[inline(always)]
