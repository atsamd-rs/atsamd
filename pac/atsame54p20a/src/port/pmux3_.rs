#[doc = "Reader of register PMUX3_%s"]
pub type R = crate::R<u8, super::PMUX3_>;
#[doc = "Writer for register PMUX3_%s"]
pub type W = crate::W<u8, super::PMUX3_>;
#[doc = "Register PMUX3_%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PMUX3_ {
    type Type = u8;
    #[inline(always)]
