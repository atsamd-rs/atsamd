#[doc = "Reader of register PINCFG2_%s"]
pub type R = crate::R<u8, super::PINCFG2_>;
#[doc = "Writer for register PINCFG2_%s"]
pub type W = crate::W<u8, super::PINCFG2_>;
#[doc = "Register PINCFG2_%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PINCFG2_ {
    type Type = u8;
    #[inline(always)]
