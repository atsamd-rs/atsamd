#[doc = "Reader of register PMUX2_%s"]
pub type R = crate::R<u8, super::PMUX2_>;
#[doc = "Writer for register PMUX2_%s"]
pub type W = crate::W<u8, super::PMUX2_>;
#[doc = "Register PMUX2_%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PMUX2_ {
    type Type = u8;
    #[inline(always)]
