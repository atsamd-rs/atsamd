#[doc = "Reader of register PINCFG3_%s"]
pub type R = crate::R<u8, super::PINCFG3_>;
#[doc = "Writer for register PINCFG3_%s"]
pub type W = crate::W<u8, super::PINCFG3_>;
#[doc = "Register PINCFG3_%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PINCFG3_ {
    type Type = u8;
    #[inline(always)]
