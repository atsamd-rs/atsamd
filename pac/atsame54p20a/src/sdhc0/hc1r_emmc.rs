#[doc = "Reader of register HC1R_EMMC"]
pub type R = crate::R<u8, super::HC1R_EMMC>;
#[doc = "Writer for register HC1R_EMMC"]
pub type W = crate::W<u8, super::HC1R_EMMC>;
#[doc = "Register HC1R_EMMC `reset()`'s with value 0"]
impl crate::ResetValue for super::HC1R_EMMC {
    type Type = u8;
    #[inline(always)]
