#[doc = "Reader of register TSSSL"]
pub type R = crate::R<u32, super::TSSSL>;
#[doc = "Writer for register TSSSL"]
pub type W = crate::W<u32, super::TSSSL>;
#[doc = "Register TSSSL `reset()`'s with value 0"]
impl crate::ResetValue for super::TSSSL {
    type Type = u32;
    #[inline(always)]
