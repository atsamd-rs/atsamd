...
impl R {
    #[doc = "Bit 0 - Break Interrupt Enable"]
    #[inline(always)]
    pub fn brk(&self) -> BRK_R {
        BRK_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Inter-Processor Signal Interrupt Enable for CPU 0"]
    #[inline(always)]
    pub fn ips0(&self) -> IPS0_R {
        IPS0_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Inter-Processor Signal Interrupt Enable for CPU 1"]
    #[inline(always)]
