#[doc = "Reader of register GLOBMASK"]
pub type R = crate::R<u8, super::GLOBMASK>;
#[doc = "Writer for register GLOBMASK"]
pub type W = crate::W<u8, super::GLOBMASK>;
#[doc = "Register GLOBMASK `reset()`'s with value 0"]
impl crate::ResetValue for super::GLOBMASK {
    type Type = u8;
    #[inline(always)]
