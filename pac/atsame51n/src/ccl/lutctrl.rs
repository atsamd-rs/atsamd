...
impl EDGESEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> EDGESELSELECT_A {
        match self.bits {
...
pub type EDGESEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, EDGESELSELECT_A>;
impl<'a, REG, const O: u8> EDGESEL_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Edge detector is disabled"]
...
impl INVEI_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> INVEISELECT_A {
        match self.bits {
...
pub type INVEI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, INVEISELECT_A>;
impl<'a, REG, const O: u8> INVEI_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Incoming event is not inverted"]
...
impl LUTEI_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> LUTEISELECT_A {
        match self.bits {
...
pub type LUTEI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, LUTEISELECT_A>;
impl<'a, REG, const O: u8> LUTEI_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "LUT incoming event is disabled"]
...
impl LUTEO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> LUTEOSELECT_A {
        match self.bits {
...
pub type LUTEO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, LUTEOSELECT_A>;
impl<'a, REG, const O: u8> LUTEO_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "LUT event output is disabled"]
