...
impl From<GENCTRL0_A> for u16 {
    ...
    fn from(variant: GENCTRL0_A) -> Self {
        match variant {
            ...
            GENCTRL0_A::GCLK5 => 32,
            GENCTRL0_A::GCLK6 => 64,
            GENCTRL0_A::GCLK7 => 128,
            GENCTRL0_A::GCLK8 => 256,
            GENCTRL0_A::GCLK9 => 512,
            GENCTRL0_A::GCLK10 => 1024,
            GENCTRL0_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL1_A> for u16 {
    ...
    fn from(variant: GENCTRL1_A) -> Self {
        match variant {
            ...
            GENCTRL1_A::GCLK5 => 32,
            GENCTRL1_A::GCLK6 => 64,
            GENCTRL1_A::GCLK7 => 128,
            GENCTRL1_A::GCLK8 => 256,
            GENCTRL1_A::GCLK9 => 512,
            GENCTRL1_A::GCLK10 => 1024,
            GENCTRL1_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL2_A> for u16 {
    ...
    fn from(variant: GENCTRL2_A) -> Self {
        match variant {
            ...
            GENCTRL2_A::GCLK5 => 32,
            GENCTRL2_A::GCLK6 => 64,
            GENCTRL2_A::GCLK7 => 128,
            GENCTRL2_A::GCLK8 => 256,
            GENCTRL2_A::GCLK9 => 512,
            GENCTRL2_A::GCLK10 => 1024,
            GENCTRL2_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL3_A> for u16 {
    ...
    fn from(variant: GENCTRL3_A) -> Self {
        match variant {
            ...
            GENCTRL3_A::GCLK5 => 32,
            GENCTRL3_A::GCLK6 => 64,
            GENCTRL3_A::GCLK7 => 128,
            GENCTRL3_A::GCLK8 => 256,
            GENCTRL3_A::GCLK9 => 512,
            GENCTRL3_A::GCLK10 => 1024,
            GENCTRL3_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL4_A> for u16 {
    ...
    fn from(variant: GENCTRL4_A) -> Self {
        match variant {
            ...
            GENCTRL4_A::GCLK5 => 32,
            GENCTRL4_A::GCLK6 => 64,
            GENCTRL4_A::GCLK7 => 128,
            GENCTRL4_A::GCLK8 => 256,
            GENCTRL4_A::GCLK9 => 512,
            GENCTRL4_A::GCLK10 => 1024,
            GENCTRL4_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL5_A> for u16 {
    ...
    fn from(variant: GENCTRL5_A) -> Self {
        match variant {
            ...
            GENCTRL5_A::GCLK5 => 32,
            GENCTRL5_A::GCLK6 => 64,
            GENCTRL5_A::GCLK7 => 128,
            GENCTRL5_A::GCLK8 => 256,
            GENCTRL5_A::GCLK9 => 512,
            GENCTRL5_A::GCLK10 => 1024,
            GENCTRL5_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL6_A> for u16 {
    ...
    fn from(variant: GENCTRL6_A) -> Self {
        match variant {
            ...
            GENCTRL6_A::GCLK5 => 32,
            GENCTRL6_A::GCLK6 => 64,
            GENCTRL6_A::GCLK7 => 128,
            GENCTRL6_A::GCLK8 => 256,
            GENCTRL6_A::GCLK9 => 512,
            GENCTRL6_A::GCLK10 => 1024,
            GENCTRL6_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL7_A> for u16 {
    ...
    fn from(variant: GENCTRL7_A) -> Self {
        match variant {
            ...
            GENCTRL7_A::GCLK5 => 32,
            GENCTRL7_A::GCLK6 => 64,
            GENCTRL7_A::GCLK7 => 128,
            GENCTRL7_A::GCLK8 => 256,
            GENCTRL7_A::GCLK9 => 512,
            GENCTRL7_A::GCLK10 => 1024,
            GENCTRL7_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL8_A> for u16 {
    ...
    fn from(variant: GENCTRL8_A) -> Self {
        match variant {
            ...
            GENCTRL8_A::GCLK5 => 32,
            GENCTRL8_A::GCLK6 => 64,
            GENCTRL8_A::GCLK7 => 128,
            GENCTRL8_A::GCLK8 => 256,
            GENCTRL8_A::GCLK9 => 512,
            GENCTRL8_A::GCLK10 => 1024,
            GENCTRL8_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL9_A> for u16 {
    ...
    fn from(variant: GENCTRL9_A) -> Self {
        match variant {
            ...
            GENCTRL9_A::GCLK5 => 32,
            GENCTRL9_A::GCLK6 => 64,
            GENCTRL9_A::GCLK7 => 128,
            GENCTRL9_A::GCLK8 => 256,
            GENCTRL9_A::GCLK9 => 512,
            GENCTRL9_A::GCLK10 => 1024,
            GENCTRL9_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL10_A> for u16 {
    ...
    fn from(variant: GENCTRL10_A) -> Self {
        match variant {
            ...
            GENCTRL10_A::GCLK2 => 4,
            GENCTRL10_A::GCLK3 => 8,
            GENCTRL10_A::GCLK4 => 16,
            GENCTRL10_A::GCLK5 => 32,
            GENCTRL10_A::GCLK6 => 64,
            GENCTRL10_A::GCLK7 => 128,
            GENCTRL10_A::GCLK8 => 256,
            GENCTRL10_A::GCLK9 => 512,
            GENCTRL10_A::GCLK10 => 1024,
            GENCTRL10_A::GCLK11 => 2048,
        }
    }
}
...
impl From<GENCTRL11_A> for u16 {
    ...
    fn from(variant: GENCTRL11_A) -> Self {
        match variant {
            ...
            GENCTRL11_A::GCLK2 => 4,
            GENCTRL11_A::GCLK3 => 8,
            GENCTRL11_A::GCLK4 => 16,
            GENCTRL11_A::GCLK5 => 32,
            GENCTRL11_A::GCLK6 => 64,
            GENCTRL11_A::GCLK7 => 128,
            GENCTRL11_A::GCLK8 => 256,
            GENCTRL11_A::GCLK9 => 512,
            GENCTRL11_A::GCLK10 => 1024,
            GENCTRL11_A::GCLK11 => 2048,
        }
    }
}
