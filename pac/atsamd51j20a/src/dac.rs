...
#[doc = "Synchronization Busy"]
pub mod syncbusy;
#[doc = "DAC n Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about avaliable fields see [dacctrl](dacctrl) module"]
pub type DACCTRL = crate::Reg<u16, _DACCTRL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _DACCTRL;
#[doc = "`read()` method returns [dacctrl::R](dacctrl::R) reader structure"]
impl crate::Readable for DACCTRL {}
#[doc = "`write(|w| ..)` method takes [dacctrl::W](dacctrl::W) writer structure"]
impl crate::Writable for DACCTRL {}
#[doc = "DAC n Control"]
pub mod dacctrl;
