...
pub type CMDC_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, CMDCSELECT_A, O>;
...
pub type TRFC_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, TRFCSELECT_A, O>;
...
pub type BLKGE_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, BLKGESELECT_A, O>;
...
pub type DMAINT_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, DMAINTSELECT_A, O>;
...
pub type BWRRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, BWRRDYSELECT_A, O>;
...
pub type BRDRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, BRDRDYSELECT_A, O>;
...
pub type BOOTAR_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISTER_EMMC_MODE_SPEC, bool, O>;
impl R {
