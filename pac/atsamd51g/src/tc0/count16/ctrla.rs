...
pub type CAPTMODE0_R = crate::FieldReader<u8, CAPTMODE0SELECT_A>;
...
pub type CAPTMODE0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CTRLA_SPEC, u8, CAPTMODE0SELECT_A, 2, O>;
...
pub type CAPTMODE1_R = crate::FieldReader<u8, CAPTMODE1SELECT_A>;
...
pub type CAPTMODE1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CTRLA_SPEC, u8, CAPTMODE1SELECT_A, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaos(&mut self) -> DMAOS_W<15> {
        DMAOS_W::new(self)
    }
    #[doc = "Bit 16 - Capture Channel 0 Enable"]
    #[inline(always)]
