...
pub type LDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DPLLRATIO_SPEC, u16, u16, 13, O>;
...
pub type LDRFRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DPLLRATIO_SPEC, u8, u8, 5, O>;
impl R {
