...
impl FamilyR {
    ...
    pub const fn variant(&self) -> Option<Familyselect> {
        match self.bits {
            3 => Some(Familyselect::Family1),
            _ => None,
        }
    }
    #[doc = "PIC32CX Advanced Feature Set Microcontrollers"]
    #[inline(always)]
    pub fn is_family_1(&self) -> bool {
        *self == Familyselect::Family1
    }
}
#[doc = "Processor\n\nValue on reset: 6"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "`reset()` method sets DID to value 0x6182_0501"]
impl crate::Resettable for DidSpec {
    const RESET_VALUE: u32 = 0x6182_0501;
}
