...
pub type SuspendW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type SofW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type EorstW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type WakeupW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type EorsmW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type UprsmW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type RamacerW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type LpmnyetW<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type LpmsuspW<'a, REG> = crate::BitWriter1S<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suspend(&mut self) -> SuspendW<IntensetSpec> {
        SuspendW::new(self, 0)
    }
    #[doc = "Bit 2 - Start Of Frame Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn eorst(&mut self) -> EorstW<IntensetSpec> {
        EorstW::new(self, 3)
    }
    #[doc = "Bit 4 - Wake Up Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn eorsm(&mut self) -> EorsmW<IntensetSpec> {
        EorsmW::new(self, 5)
    }
    #[doc = "Bit 6 - Upstream Resume Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpmnyet(&mut self) -> LpmnyetW<IntensetSpec> {
        LpmnyetW::new(self, 8)
    }
    #[doc = "Bit 9 - Link Power Management Suspend Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lpmsusp(&mut self) -> LpmsuspW<IntensetSpec> {
        LpmsuspW::new(self, 9)
    }
}
