...
impl RegisterBlock {
    ...
    #[doc = "0x29 - Boot Control"]
    #[inline(always)]
    pub const fn bctrl(&self) -> &Bctrl {
        &self.bctrl
    }
...
#[doc = "Debug Control"]
pub mod dbgctrl;
#[doc = "BCTRL (rw) register accessor: Boot Control\n\nYou can [`read`](crate::Reg::read) this register and get [`bctrl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bctrl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@bctrl`]
module"]
#[doc(alias = "BCTRL")]
pub type Bctrl = crate::Reg<bctrl::BctrlSpec>;
#[doc = "Boot Control"]
pub mod bctrl;
