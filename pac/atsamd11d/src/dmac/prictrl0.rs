...
pub type LVLPRI0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type LVLPRI1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type LVLPRI2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type LVLPRI3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
