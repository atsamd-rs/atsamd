...
impl crate::ToBits<u8> for BLANK_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            BLANK_A::NONE => 0,
...
impl crate::ToBits<u8> for HALT_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            HALT_A::DISABLE => 0,
...
impl crate::ToBits<u8> for CHSEL_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CHSEL_A::CC0 => 0,
...
impl crate::ToBits<u8> for CAPTURE_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CAPTURE_A::DISABLE => 0,
...
impl CAPTURE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, CAPTURE_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(CAPTURE_A::DISABLE),
            1 => Val(CAPTURE_A::CAPT),
            2 => Val(CAPTURE_A::CAPTMIN),
            3 => Val(CAPTURE_A::CAPTMAX),
            4 => Val(CAPTURE_A::LOCMIN),
            5 => Val(CAPTURE_A::LOCMAX),
            6 => Val(CAPTURE_A::DERIV0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
