#[doc = "Reader of register SERCTRL%s"]
pub type R = crate::R<u32, super::SERCTRL>;
#[doc = "Writer for register SERCTRL%s"]
pub type W = crate::W<u32, super::SERCTRL>;
#[doc = "Register SERCTRL%s `reset()`'s with value 0"]
impl crate::ResetValue for super::SERCTRL {
    type Type = u32;
    #[inline(always)]
...
impl crate::ToBits<u8> for SERMODE_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            SERMODE_A::RX => 0,
...
impl crate::ToBits<u8> for TXDEFAULT_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            TXDEFAULT_A::ZERO => 0,
...
impl crate::ToBits<bool> for TXSAME_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            TXSAME_A::ZERO => false,
...
impl crate::ToBits<bool> for CLKSEL_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            CLKSEL_A::CLK0 => false,
...
impl crate::ToBits<bool> for SLOTADJ_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<u8> for DATASIZE_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            DATASIZE_A::_32 => 0,
...
impl crate::ToBits<bool> for WORDADJ_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<u8> for EXTEND_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            EXTEND_A::ZERO => 0,
...
impl crate::ToBits<bool> for BITREV_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<bool> for MONO_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            MONO_A::STEREO => false,
...
impl crate::ToBits<bool> for DMA_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            DMA_A::SINGLE => false,
