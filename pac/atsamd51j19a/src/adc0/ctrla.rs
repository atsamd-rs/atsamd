...
impl PRESCALERR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            PRESCALERR::DIV2 => 0,
            PRESCALERR::DIV4 => 0x01,
            PRESCALERR::DIV8 => 0x02,
            PRESCALERR::DIV16 => 0x03,
            PRESCALERR::DIV32 => 0x04,
            PRESCALERR::DIV64 => 0x05,
            PRESCALERR::DIV128 => 0x06,
            PRESCALERR::DIV256 => 0x07,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl<'a> _DUALSELW<'a> {
    ...
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        self.w.bits &= !(0x03 << 3);
        self.w.bits |= ((value as u16) & 0x03) << 3;
        self.w
    }
}
#[doc = r" Proxy"]
...
impl R {
    ...
    pub fn dualsel(&self) -> DUALSELR {
        DUALSELR::_from(((self.bits >> 3) & 0x03) as u8)
    }
