#[doc = "Reader of register CCBUF%s_DITH6"]
pub type R = crate::R<u32, super::CCBUF_DITH6>;
#[doc = "Writer for register CCBUF%s_DITH6"]
pub type W = crate::W<u32, super::CCBUF_DITH6>;
#[doc = "Register CCBUF%s_DITH6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CCBUF_DITH6 {
    type Type = u32;
    #[inline(always)]
