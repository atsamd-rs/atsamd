...
pub type R = crate::R<WPSET_SPEC>;
#[doc = "Register `WPSET` writer"]
pub type W = crate::W<WPSET_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wp(&mut self) -> WP_W<WPSET_SPEC, 1> {
        WP_W::new(self)
    }
...
#[doc = "Write Protection Set\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wpset::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wpset::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
