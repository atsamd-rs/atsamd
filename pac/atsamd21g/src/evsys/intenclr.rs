...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovr8(&mut self) -> OVR8_W<INTENCLR_SPEC, 16> {
        OVR8_W::new(self)
    }
    #[doc = "Bit 17 - Channel 9 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr9(&mut self) -> OVR9_W<INTENCLR_SPEC, 17> {
        OVR9_W::new(self)
    }
    #[doc = "Bit 18 - Channel 10 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr10(&mut self) -> OVR10_W<INTENCLR_SPEC, 18> {
        OVR10_W::new(self)
    }
    #[doc = "Bit 19 - Channel 11 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr11(&mut self) -> OVR11_W<INTENCLR_SPEC, 19> {
        OVR11_W::new(self)
    }
    #[doc = "Bit 24 - Channel 8 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd8(&mut self) -> EVD8_W<INTENCLR_SPEC, 24> {
        EVD8_W::new(self)
    }
    #[doc = "Bit 25 - Channel 9 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd9(&mut self) -> EVD9_W<INTENCLR_SPEC, 25> {
        EVD9_W::new(self)
    }
    #[doc = "Bit 26 - Channel 10 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd10(&mut self) -> EVD10_W<INTENCLR_SPEC, 26> {
        EVD10_W::new(self)
    }
    #[doc = "Bit 27 - Channel 11 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd11(&mut self) -> EVD11_W<INTENCLR_SPEC, 27> {
        EVD11_W::new(self)
    }
