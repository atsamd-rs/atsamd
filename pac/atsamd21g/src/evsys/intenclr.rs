...
impl W {
    ...
    #[doc = "Bit 6 - Channel 6 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr6(&mut self) -> Ovr6W<IntenclrSpec> {
        Ovr6W::new(self, 6)
    }
    #[doc = "Bit 7 - Channel 7 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr7(&mut self) -> Ovr7W<IntenclrSpec> {
        Ovr7W::new(self, 7)
    }
    #[doc = "Bit 8 - Channel 0 Event Detection Interrupt Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Channel 6 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd6(&mut self) -> Evd6W<IntenclrSpec> {
        Evd6W::new(self, 14)
    }
    #[doc = "Bit 15 - Channel 7 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd7(&mut self) -> Evd7W<IntenclrSpec> {
        Evd7W::new(self, 15)
    }
    #[doc = "Bit 16 - Channel 8 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr8(&mut self) -> Ovr8W<IntenclrSpec> {
        Ovr8W::new(self, 16)
    }
    #[doc = "Bit 17 - Channel 9 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr9(&mut self) -> Ovr9W<IntenclrSpec> {
        Ovr9W::new(self, 17)
    }
    #[doc = "Bit 18 - Channel 10 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr10(&mut self) -> Ovr10W<IntenclrSpec> {
        Ovr10W::new(self, 18)
    }
    #[doc = "Bit 19 - Channel 11 Overrun Interrupt Enable"]
    #[inline(always)]
    pub fn ovr11(&mut self) -> Ovr11W<IntenclrSpec> {
        Ovr11W::new(self, 19)
    }
    #[doc = "Bit 24 - Channel 8 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd8(&mut self) -> Evd8W<IntenclrSpec> {
        Evd8W::new(self, 24)
    }
    #[doc = "Bit 25 - Channel 9 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd9(&mut self) -> Evd9W<IntenclrSpec> {
        Evd9W::new(self, 25)
    }
    #[doc = "Bit 26 - Channel 10 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd10(&mut self) -> Evd10W<IntenclrSpec> {
        Evd10W::new(self, 26)
    }
    #[doc = "Bit 27 - Channel 11 Event Detection Interrupt Enable"]
    #[inline(always)]
    pub fn evd11(&mut self) -> Evd11W<IntenclrSpec> {
        Evd11W::new(self, 27)
    }
}
