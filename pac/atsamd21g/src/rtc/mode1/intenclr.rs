...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0(&mut self) -> CMP0_W<INTENCLR_SPEC, 0> {
        CMP0_W::new(self)
    }
    #[doc = "Bit 1 - Compare 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<INTENCLR_SPEC, 1> {
        CMP1_W::new(self)
    }
    #[doc = "Bit 6 - Synchronization Ready Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncrdy(&mut self) -> SYNCRDY_W<INTENCLR_SPEC, 6> {
        SYNCRDY_W::new(self)
    }
    #[doc = "Bit 7 - Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovf(&mut self) -> OVF_W<INTENCLR_SPEC, 7> {
        OVF_W::new(self)
    }
