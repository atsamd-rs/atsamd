#[doc = "Reader of register PINTENCLR%s"]
pub type R = crate::R<u8, super::PINTENCLR>;
#[doc = "Writer for register PINTENCLR%s"]
pub type W = crate::W<u8, super::PINTENCLR>;
#[doc = "Register PINTENCLR%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PINTENCLR {
    type Type = u8;
    #[inline(always)]
