#[doc = "Writer for register PSTATUSCLR%s"]
pub type W = crate::W<u8, super::PSTATUSCLR>;
#[doc = "Register PSTATUSCLR%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PSTATUSCLR {
    type Type = u8;
    #[inline(always)]
