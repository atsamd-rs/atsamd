...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ferr(&mut self) -> FERR_W<2> {
        FERR_W::new(self)
    }
    #[doc = "Bit 3 - Channel CRC Error"]
    #[inline(always)]
    #[must_use]
    pub fn crcerr(&mut self) -> CRCERR_W<3> {
        CRCERR_W::new(self)
    }
