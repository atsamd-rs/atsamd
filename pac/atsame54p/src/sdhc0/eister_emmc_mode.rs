...
pub type R = crate::R<EISTER_EMMC_MODE_SPEC>;
#[doc = "Register `EISTER_EMMC_MODE` writer"]
pub type W = crate::W<EISTER_EMMC_MODE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdteo(&mut self) -> CMDTEO_W<EISTER_EMMC_MODE_SPEC, 0> {
        CMDTEO_W::new(self)
    }
    #[doc = "Bit 1 - Command CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrc(&mut self) -> CMDCRC_W<EISTER_EMMC_MODE_SPEC, 1> {
        CMDCRC_W::new(self)
    }
    #[doc = "Bit 2 - Command End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdend(&mut self) -> CMDEND_W<EISTER_EMMC_MODE_SPEC, 2> {
        CMDEND_W::new(self)
    }
    #[doc = "Bit 3 - Command Index Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdidx(&mut self) -> CMDIDX_W<EISTER_EMMC_MODE_SPEC, 3> {
        CMDIDX_W::new(self)
    }
    #[doc = "Bit 4 - Data Timeout Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datteo(&mut self) -> DATTEO_W<EISTER_EMMC_MODE_SPEC, 4> {
        DATTEO_W::new(self)
    }
    #[doc = "Bit 5 - Data CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datcrc(&mut self) -> DATCRC_W<EISTER_EMMC_MODE_SPEC, 5> {
        DATCRC_W::new(self)
    }
    #[doc = "Bit 6 - Data End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datend(&mut self) -> DATEND_W<EISTER_EMMC_MODE_SPEC, 6> {
        DATEND_W::new(self)
    }
    #[doc = "Bit 7 - Current Limit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn curlim(&mut self) -> CURLIM_W<EISTER_EMMC_MODE_SPEC, 7> {
        CURLIM_W::new(self)
    }
    #[doc = "Bit 8 - Auto CMD Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmd(&mut self) -> ACMD_W<EISTER_EMMC_MODE_SPEC, 8> {
        ACMD_W::new(self)
    }
    #[doc = "Bit 9 - ADMA Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn adma(&mut self) -> ADMA_W<EISTER_EMMC_MODE_SPEC, 9> {
        ADMA_W::new(self)
    }
    #[doc = "Bit 12 - Boot Acknowledge Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bootae(&mut self) -> BOOTAE_W<EISTER_EMMC_MODE_SPEC, 12> {
        BOOTAE_W::new(self)
    }
