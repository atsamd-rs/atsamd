...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxrdy0(&mut self) -> RXRDY0_W<INTENSET_SPEC, 0> {
        RXRDY0_W::new(self)
    }
    #[doc = "Bit 1 - Receive Ready 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxrdy1(&mut self) -> RXRDY1_W<INTENSET_SPEC, 1> {
        RXRDY1_W::new(self)
    }
    #[doc = "Bit 4 - Receive Overrun 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxor0(&mut self) -> RXOR0_W<INTENSET_SPEC, 4> {
        RXOR0_W::new(self)
    }
    #[doc = "Bit 5 - Receive Overrun 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxor1(&mut self) -> RXOR1_W<INTENSET_SPEC, 5> {
        RXOR1_W::new(self)
    }
    #[doc = "Bit 8 - Transmit Ready 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy0(&mut self) -> TXRDY0_W<INTENSET_SPEC, 8> {
        TXRDY0_W::new(self)
    }
    #[doc = "Bit 9 - Transmit Ready 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy1(&mut self) -> TXRDY1_W<INTENSET_SPEC, 9> {
        TXRDY1_W::new(self)
    }
    #[doc = "Bit 12 - Transmit Underrun 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txur0(&mut self) -> TXUR0_W<INTENSET_SPEC, 12> {
        TXUR0_W::new(self)
    }
    #[doc = "Bit 13 - Transmit Underrun 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txur1(&mut self) -> TXUR1_W<INTENSET_SPEC, 13> {
        TXUR1_W::new(self)
    }
