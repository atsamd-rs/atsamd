...
pub type GMAC__W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBMASK_SPEC, bool, O>;
...
pub type CAN0__W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBMASK_SPEC, bool, O>;
...
pub type CAN1__W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBMASK_SPEC, bool, O>;
...
impl R {
    ...
    pub fn can0_(&self) -> CAN0__R {
        CAN0__R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - CAN1 AHB Clock Mask"]
    #[inline(always)]
    pub fn can1_(&self) -> CAN1__R {
        CAN1__R::new(((self.bits >> 18) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gmac_(&mut self) -> GMAC__W<14> {
        GMAC__W::new(self)
    }
    #[doc = "Bit 15 - SDHC0 AHB Clock Mask"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn can0_(&mut self) -> CAN0__W<17> {
        CAN0__W::new(self)
    }
    #[doc = "Bit 18 - CAN1 AHB Clock Mask"]
    #[inline(always)]
    #[must_use]
    pub fn can1_(&mut self) -> CAN1__W<18> {
        CAN1__W::new(self)
    }
    #[doc = "Bit 19 - ICM AHB Clock Mask"]
    #[inline(always)]
