...
#[doc = "Reader of field `GMAC_`"]
pub type GMAC__R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GMAC_`"]
...
#[doc = "Reader of field `SDHC1_`"]
pub type SDHC1__R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SDHC1_`"]
