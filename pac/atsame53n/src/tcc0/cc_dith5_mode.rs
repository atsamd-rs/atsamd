...
pub type DITHER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC_DITH5_MODE_SPEC, u8, u8, 5, O>;
...
pub type CC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC_DITH5_MODE_SPEC, u32, u32, 19, O>;
impl R {
