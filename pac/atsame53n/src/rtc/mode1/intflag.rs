...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0(&mut self) -> CMP0_W<INTFLAG_SPEC, 8> {
        CMP0_W::new(self)
    }
    #[doc = "Bit 9 - Compare 1"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1(&mut self) -> CMP1_W<INTFLAG_SPEC, 9> {
        CMP1_W::new(self)
    }
    #[doc = "Bit 10 - Compare 2"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> CMP2_W<INTFLAG_SPEC, 10> {
        CMP2_W::new(self)
    }
    #[doc = "Bit 11 - Compare 3"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> CMP3_W<INTFLAG_SPEC, 11> {
        CMP3_W::new(self)
    }
    #[doc = "Bit 14 - Tamper"]
    #[inline(always)]
