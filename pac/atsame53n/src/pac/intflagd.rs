...
pub type SERCOM6__R = crate::BitReader<bool>;
#[doc = "Field `SERCOM6_` writer - SERCOM6"]
pub type SERCOM6__W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFLAGD_SPEC, bool, O>;
#[doc = "Field `SERCOM7_` reader - SERCOM7"]
pub type SERCOM7__R = crate::BitReader<bool>;
#[doc = "Field `SERCOM7_` writer - SERCOM7"]
pub type SERCOM7__W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFLAGD_SPEC, bool, O>;
...
pub type TC6__R = crate::BitReader<bool>;
#[doc = "Field `TC6_` writer - TC6"]
pub type TC6__W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFLAGD_SPEC, bool, O>;
#[doc = "Field `TC7_` reader - TC7"]
pub type TC7__R = crate::BitReader<bool>;
#[doc = "Field `TC7_` writer - TC7"]
pub type TC7__W<'a, const O: u8> = crate::BitWriter<'a, u32, INTFLAGD_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sercom6_(&mut self) -> SERCOM6__W<2> {
        SERCOM6__W::new(self)
    }
    #[doc = "Bit 3 - SERCOM7"]
    #[inline(always)]
    #[must_use]
    pub fn sercom7_(&mut self) -> SERCOM7__W<3> {
        SERCOM7__W::new(self)
    }
    #[doc = "Bit 4 - TCC4"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tc6_(&mut self) -> TC6__W<5> {
        TC6__W::new(self)
    }
    #[doc = "Bit 6 - TC7"]
    #[inline(always)]
    #[must_use]
    pub fn tc7_(&mut self) -> TC7__W<6> {
        TC7__W::new(self)
    }
    #[doc = "Bit 7 - ADC0"]
    #[inline(always)]
