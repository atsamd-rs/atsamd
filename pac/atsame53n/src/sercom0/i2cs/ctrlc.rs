...
pub type SDASETUP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SDASETUP` writer - SDA Setup Time"]
pub type SDASETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLC_SPEC, u8, u8, 4, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdasetup(&mut self) -> SDASETUP_W<0> {
        SDASETUP_W::new(self)
    }
    #[doc = "Bit 24 - Data 32 Bit"]
    #[inline(always)]
