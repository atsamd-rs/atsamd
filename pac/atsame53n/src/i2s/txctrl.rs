...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sermode(&mut self) -> SERMODE_W<TXCTRL_SPEC, 0> {
        SERMODE_W::new(self)
    }
    #[doc = "Bits 2:3 - Line Default Line when Slot Disabled"]
    #[inline(always)]
    #[must_use]
    pub fn txdefault(&mut self) -> TXDEFAULT_W<TXCTRL_SPEC, 2> {
        TXDEFAULT_W::new(self)
    }
    #[doc = "Bit 4 - Transmit Data when Underrun"]
    #[inline(always)]
    #[must_use]
    pub fn txsame(&mut self) -> TXSAME_W<TXCTRL_SPEC, 4> {
        TXSAME_W::new(self)
    }
    #[doc = "Bit 5 - Clock Unit Selection"]
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> CLKSEL_W<TXCTRL_SPEC, 5> {
        CLKSEL_W::new(self)
    }
    #[doc = "Bit 7 - Data Slot Formatting Adjust"]
    #[inline(always)]
    #[must_use]
    pub fn slotadj(&mut self) -> SLOTADJ_W<TXCTRL_SPEC, 7> {
        SLOTADJ_W::new(self)
    }
    #[doc = "Bits 8:10 - Data Word Size"]
    #[inline(always)]
    #[must_use]
    pub fn datasize(&mut self) -> DATASIZE_W<TXCTRL_SPEC, 8> {
        DATASIZE_W::new(self)
    }
    #[doc = "Bit 12 - Data Word Formatting Adjust"]
    #[inline(always)]
    #[must_use]
    pub fn wordadj(&mut self) -> WORDADJ_W<TXCTRL_SPEC, 12> {
        WORDADJ_W::new(self)
    }
    #[doc = "Bits 13:14 - Data Formatting Bit Extension"]
    #[inline(always)]
    #[must_use]
    pub fn extend(&mut self) -> EXTEND_W<TXCTRL_SPEC, 13> {
        EXTEND_W::new(self)
    }
    #[doc = "Bit 15 - Data Formatting Bit Reverse"]
    #[inline(always)]
    #[must_use]
    pub fn bitrev(&mut self) -> BITREV_W<TXCTRL_SPEC, 15> {
        BITREV_W::new(self)
    }
    #[doc = "Bit 16 - Slot 0 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis0(&mut self) -> SLOTDIS0_W<TXCTRL_SPEC, 16> {
        SLOTDIS0_W::new(self)
    }
    #[doc = "Bit 17 - Slot 1 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis1(&mut self) -> SLOTDIS1_W<TXCTRL_SPEC, 17> {
        SLOTDIS1_W::new(self)
    }
    #[doc = "Bit 18 - Slot 2 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis2(&mut self) -> SLOTDIS2_W<TXCTRL_SPEC, 18> {
        SLOTDIS2_W::new(self)
    }
    #[doc = "Bit 19 - Slot 3 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis3(&mut self) -> SLOTDIS3_W<TXCTRL_SPEC, 19> {
        SLOTDIS3_W::new(self)
    }
    #[doc = "Bit 20 - Slot 4 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis4(&mut self) -> SLOTDIS4_W<TXCTRL_SPEC, 20> {
        SLOTDIS4_W::new(self)
    }
    #[doc = "Bit 21 - Slot 5 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis5(&mut self) -> SLOTDIS5_W<TXCTRL_SPEC, 21> {
        SLOTDIS5_W::new(self)
    }
    #[doc = "Bit 22 - Slot 6 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis6(&mut self) -> SLOTDIS6_W<TXCTRL_SPEC, 22> {
        SLOTDIS6_W::new(self)
    }
    #[doc = "Bit 23 - Slot 7 Disabled for this Serializer"]
    #[inline(always)]
    #[must_use]
    pub fn slotdis7(&mut self) -> SLOTDIS7_W<TXCTRL_SPEC, 23> {
        SLOTDIS7_W::new(self)
    }
    #[doc = "Bit 24 - Mono Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mono(&mut self) -> MONO_W<TXCTRL_SPEC, 24> {
        MONO_W::new(self)
    }
    #[doc = "Bit 25 - Single or Multiple DMA Channels"]
    #[inline(always)]
    #[must_use]
    pub fn dma(&mut self) -> DMA_W<TXCTRL_SPEC, 25> {
        DMA_W::new(self)
    }
