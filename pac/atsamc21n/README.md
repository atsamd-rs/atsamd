...
A peripheral access crate for the ATSAMC21N chip from Microchip (née Atmel) for Rust Embedded projects.

[![Build Status](https://travis-ci.org/atsamd-rs/atsamd.svg?branch=master)](https://travis-ci.org/atsamd-rs/atsamd)
[![Crates.io](https://img.shields.io/crates/v/atsamc21n.svg)](https://crates.io/crates/atsamc21n)

## [Documentation](https://docs.rs/atsamc21n)
