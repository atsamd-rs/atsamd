...
pub struct RegisterBlock {
    ...
    _reserved2: [u8; 0x18],
    #[doc = "0x20..0x44 - Generic Clock Generator Control"]
    pub genctrl: [crate::Reg<genctrl::GENCTRL_SPEC>; 9],
    _reserved3: [u8; 0x3c],
    #[doc = "0x80..0x138 - Peripheral Clock Control"]
    pub pchctrl: [crate::Reg<pchctrl::PCHCTRL_SPEC>; 46],
}
