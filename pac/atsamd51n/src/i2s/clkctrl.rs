...
pub type MCKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLKCTRL_SPEC, u8, u8, 6, O>;
...
pub type MCKOUTDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLKCTRL_SPEC, u8, u8, 6, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsinv(&mut self) -> FSINV_W<9> {
        FSINV_W::new(self)
    }
    #[doc = "Bit 10 - Frame Sync Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn fsoutinv(&mut self) -> FSOUTINV_W<10> {
        FSOUTINV_W::new(self)
    }
    #[doc = "Bit 11 - Serial Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn scksel(&mut self) -> SCKSEL_W<11> {
        SCKSEL_W::new(self)
    }
    #[doc = "Bit 12 - Serial Clock Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn sckoutinv(&mut self) -> SCKOUTINV_W<12> {
        SCKOUTINV_W::new(self)
    }
    #[doc = "Bit 13 - Master Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn mcksel(&mut self) -> MCKSEL_W<13> {
        MCKSEL_W::new(self)
    }
    #[doc = "Bit 14 - Master Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mcken(&mut self) -> MCKEN_W<14> {
        MCKEN_W::new(self)
    }
    #[doc = "Bit 15 - Master Clock Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn mckoutinv(&mut self) -> MCKOUTINV_W<15> {
        MCKOUTINV_W::new(self)
    }
    #[doc = "Bits 16:21 - Master Clock Division Factor"]
    #[inline(always)]
    #[must_use]
    pub fn mckdiv(&mut self) -> MCKDIV_W<16> {
        MCKDIV_W::new(self)
    }
    #[doc = "Bits 24:29 - Master Clock Output Division Factor"]
    #[inline(always)]
