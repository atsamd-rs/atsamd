...
pub type R = crate::R<EisierSpec>;
#[doc = "Register `EISIER` writer"]
pub type W = crate::W<EisierSpec>;
...
pub struct EisierSpec;
impl crate::RegisterSpec for EisierSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`eisier::R`](R) reader structure"]
impl crate::Readable for EisierSpec {}
