...
pub type Tc6_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TC7_` reader - TC7"]
pub type Tc7_R = crate::BitReader;
#[doc = "Field `TC7_` writer - TC7"]
pub type Tc7_W<'a, REG> = crate::BitWriter1C<'a, REG>;
