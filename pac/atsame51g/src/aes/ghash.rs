...
pub type R = crate::R<GHASH_SPEC>;
#[doc = "Register `GHASH[%s]` writer"]
pub type W = crate::W<GHASH_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<GHASH_SPEC> {
...
#[doc = "Galois Hash n\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ghash::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ghash::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
