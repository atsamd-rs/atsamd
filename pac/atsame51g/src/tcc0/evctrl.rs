...
impl Evact0R {
    ...
    pub const fn variant(&self) -> Evact0select {
        match self.bits {
            0 => Evact0select::Off,
            1 => Evact0select::Retrigger,
            2 => Evact0select::Countev,
            3 => Evact0select::Start,
            4 => Evact0select::Inc,
            5 => Evact0select::Count,
            6 => Evact0select::Stamp,
            7 => Evact0select::Fault,
            _ => unreachable!(),
        }
    }
...
pub type Evact0W<'a, REG> = crate::FieldWriter<'a, REG, 3, Evact0select, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn stamp(self) -> &'a mut crate::W<REG> {
        self.variant(Evact0select::Stamp)
    }
    #[doc = "Non-recoverable fault"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 20 - Match or Capture Channel 4 Event Input Enable"]
    #[inline(always)]
    pub fn mcei4(&mut self) -> Mcei4W<EvctrlSpec> {
        Mcei4W::new(self, 20)
    }
    #[doc = "Bit 21 - Match or Capture Channel 5 Event Input Enable"]
    #[inline(always)]
    pub fn mcei5(&mut self) -> Mcei5W<EvctrlSpec> {
        Mcei5W::new(self, 21)
    }
    #[doc = "Bit 24 - Match or Capture Channel 0 Event Output Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - Match or Capture Channel 4 Event Output Enable"]
    #[inline(always)]
    pub fn mceo4(&mut self) -> Mceo4W<EvctrlSpec> {
        Mceo4W::new(self, 28)
    }
    #[doc = "Bit 29 - Match or Capture Channel 5 Event Output Enable"]
    #[inline(always)]
    pub fn mceo5(&mut self) -> Mceo5W<EvctrlSpec> {
        Mceo5W::new(self, 29)
    }
}
