...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sercom6_(&mut self) -> SERCOM6__W<APBDMASK_SPEC, 2> {
        SERCOM6__W::new(self)
    }
    #[doc = "Bit 3 - SERCOM7 APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sercom7_(&mut self) -> SERCOM7__W<APBDMASK_SPEC, 3> {
        SERCOM7__W::new(self)
    }
    #[doc = "Bit 4 - TCC4 APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcc4_(&mut self) -> TCC4__W<APBDMASK_SPEC, 4> {
        TCC4__W::new(self)
    }
    #[doc = "Bit 5 - TC6 APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tc6_(&mut self) -> TC6__W<APBDMASK_SPEC, 5> {
        TC6__W::new(self)
    }
    #[doc = "Bit 6 - TC7 APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tc7_(&mut self) -> TC7__W<APBDMASK_SPEC, 6> {
        TC7__W::new(self)
    }
    #[doc = "Bit 7 - ADC0 APB Clock Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_(&mut self) -> I2S__W<APBDMASK_SPEC, 10> {
        I2S__W::new(self)
    }
    #[doc = "Bit 11 - PCC APB Clock Enable"]
    #[inline(always)]
