...
pub type EVGEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHANNELCTRL_SPEC, u8, u8, 7, O>;
...
pub type PATH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHANNELCTRL_SPEC, u8, PATHSELECT_A, 2, O>;
...
pub type EDGSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CHANNELCTRL_SPEC, u8, EDGSELSELECT_A, 2, O>;
...
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNELCTRL_SPEC, bool, O>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNELCTRL_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets CHANNELCTRL to value 0x8000"]
