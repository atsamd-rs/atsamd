...
pub type MCEI4_R = crate::BitReader<bool>;
#[doc = "Field `MCEI4` writer - Match or Capture Channel 4 Event Input Enable"]
pub type MCEI4_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
#[doc = "Field `MCEI5` reader - Match or Capture Channel 5 Event Input Enable"]
pub type MCEI5_R = crate::BitReader<bool>;
#[doc = "Field `MCEI5` writer - Match or Capture Channel 5 Event Input Enable"]
pub type MCEI5_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
...
pub type MCEO4_R = crate::BitReader<bool>;
#[doc = "Field `MCEO4` writer - Match or Capture Channel 4 Event Output Enable"]
pub type MCEO4_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
#[doc = "Field `MCEO5` reader - Match or Capture Channel 5 Event Output Enable"]
pub type MCEO5_R = crate::BitReader<bool>;
#[doc = "Field `MCEO5` writer - Match or Capture Channel 5 Event Output Enable"]
pub type MCEO5_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcei4(&mut self) -> MCEI4_W<20> {
        MCEI4_W::new(self)
    }
    #[doc = "Bit 21 - Match or Capture Channel 5 Event Input Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mcei5(&mut self) -> MCEI5_W<21> {
        MCEI5_W::new(self)
    }
    #[doc = "Bit 24 - Match or Capture Channel 0 Event Output Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mceo4(&mut self) -> MCEO4_W<28> {
        MCEO4_W::new(self)
    }
    #[doc = "Bit 29 - Match or Capture Channel 5 Event Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mceo5(&mut self) -> MCEO5_W<29> {
        MCEO5_W::new(self)
    }
