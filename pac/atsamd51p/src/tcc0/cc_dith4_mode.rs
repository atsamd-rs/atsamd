...
pub type DITHER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC_DITH4_MODE_SPEC, u8, u8, 4, O>;
...
pub type CC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC_DITH4_MODE_SPEC, u32, u32, 20, O>;
impl R {
