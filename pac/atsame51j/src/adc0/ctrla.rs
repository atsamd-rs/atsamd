...
pub type DUALSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, CTRLA_SPEC, u8, DUALSELSELECT_A, 2, O>;
...
pub type SLAVEEN_R = crate::BitReader<bool>;
#[doc = "Field `SLAVEEN` writer - Slave Enable"]
pub type SLAVEEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRLA_SPEC, bool, O>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRLA_SPEC, bool, O>;
...
pub type R2R_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRLA_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dualsel(&mut self) -> DUALSEL_W<3> {
        DUALSEL_W::new(self)
    }
    #[doc = "Bit 5 - Slave Enable"]
    #[inline(always)]
