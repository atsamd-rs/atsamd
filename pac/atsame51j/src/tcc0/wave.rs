...
pub type Pol4R = crate::BitReader;
#[doc = "Field `POL4` writer - Channel 4 Polarity"]
pub type Pol4W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `POL5` reader - Channel 5 Polarity"]
pub type Pol5R = crate::BitReader;
#[doc = "Field `POL5` writer - Channel 5 Polarity"]
pub type Pol5W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn pol4(&self) -> Pol4R {
        Pol4R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Channel 5 Polarity"]
    #[inline(always)]
    pub fn pol5(&self) -> Pol5R {
        Pol5R::new(((self.bits >> 21) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 20 - Channel 4 Polarity"]
    #[inline(always)]
    pub fn pol4(&mut self) -> Pol4W<WaveSpec> {
        Pol4W::new(self, 20)
    }
    #[doc = "Bit 21 - Channel 5 Polarity"]
    #[inline(always)]
    pub fn pol5(&mut self) -> Pol5W<WaveSpec> {
        Pol5W::new(self, 21)
    }
    #[doc = "Bit 24 - Swap DTI Output Pair 0"]
    #[inline(always)]
