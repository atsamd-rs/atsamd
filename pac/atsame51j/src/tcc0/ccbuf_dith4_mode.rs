...
pub type CCBUF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 20, O, u32>;
impl R {
    ...
    pub fn ccbuf(&self) -> CCBUF_R {
        CCBUF_R::new((self.bits >> 4) & 0x000f_ffff)
    }
}
impl W {
    #[doc = "Bits 0:3 - Dithering Buffer Cycle Number"]
    #[inline(always)]
    #[must_use]
    pub fn ditherbuf(&mut self) -> DITHERBUF_W<CCBUF_DITH4_MODE_SPEC, 0> {
        DITHERBUF_W::new(self)
    }
    #[doc = "Bits 4:23 - Channel Compare/Capture Buffer Value"]
    #[inline(always)]
    #[must_use]
    pub fn ccbuf(&mut self) -> CCBUF_W<CCBUF_DITH4_MODE_SPEC, 4> {
        CCBUF_W::new(self)
    }
