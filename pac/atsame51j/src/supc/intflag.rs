...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bod33rdy(&mut self) -> BOD33RDY_W<INTFLAG_SPEC, 0> {
        BOD33RDY_W::new(self)
    }
    #[doc = "Bit 1 - BOD33 Detection"]
    #[inline(always)]
    #[must_use]
    pub fn bod33det(&mut self) -> BOD33DET_W<INTFLAG_SPEC, 1> {
        BOD33DET_W::new(self)
    }
    #[doc = "Bit 2 - BOD33 Synchronization Ready"]
    #[inline(always)]
    #[must_use]
    pub fn b33srdy(&mut self) -> B33SRDY_W<INTFLAG_SPEC, 2> {
        B33SRDY_W::new(self)
    }
    #[doc = "Bit 8 - Voltage Regulator Ready"]
    #[inline(always)]
    #[must_use]
    pub fn vregrdy(&mut self) -> VREGRDY_W<INTFLAG_SPEC, 8> {
        VREGRDY_W::new(self)
    }
    #[doc = "Bit 10 - VDDCORE Ready"]
    #[inline(always)]
    #[must_use]
    pub fn vcorerdy(&mut self) -> VCORERDY_W<INTFLAG_SPEC, 10> {
        VCORERDY_W::new(self)
    }
