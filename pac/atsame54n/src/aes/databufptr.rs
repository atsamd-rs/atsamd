...
pub type R = crate::R<DATABUFPTR_SPEC>;
#[doc = "Register `DATABUFPTR` writer"]
pub type W = crate::W<DATABUFPTR_SPEC>;
#[doc = "Field `INDATAPTR` reader - Input Data Pointer"]
pub type INDATAPTR_R = crate::FieldReader;
#[doc = "Field `INDATAPTR` writer - Input Data Pointer"]
pub type INDATAPTR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn indataptr(&mut self) -> INDATAPTR_W<DATABUFPTR_SPEC, 0> {
...
#[doc = "Data buffer pointer\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`databufptr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`databufptr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
