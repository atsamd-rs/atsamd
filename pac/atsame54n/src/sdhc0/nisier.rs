...
pub type CMDC_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, CMDCSELECT_A, O>;
...
pub type TRFC_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, TRFCSELECT_A, O>;
...
pub type BLKGE_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, BLKGESELECT_A, O>;
...
pub type DMAINT_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, DMAINTSELECT_A, O>;
...
pub type BWRRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, BWRRDYSELECT_A, O>;
...
pub type BRDRDY_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, BRDRDYSELECT_A, O>;
...
pub type CINS_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, CINSSELECT_A, O>;
...
pub type CREM_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, CREMSELECT_A, O>;
...
pub type CINT_W<'a, const O: u8> = crate::BitWriter<'a, u16, NISIER_SPEC, CINTSELECT_A, O>;
