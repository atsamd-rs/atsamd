...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xoscrdy0(&mut self) -> XOSCRDY0_W<INTENCLR_SPEC, 0> {
        XOSCRDY0_W::new(self)
    }
    #[doc = "Bit 1 - XOSC 1 Ready Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn xoscrdy1(&mut self) -> XOSCRDY1_W<INTENCLR_SPEC, 1> {
        XOSCRDY1_W::new(self)
    }
    #[doc = "Bit 2 - XOSC 0 Clock Failure Detector Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn xoscfail0(&mut self) -> XOSCFAIL0_W<INTENCLR_SPEC, 2> {
        XOSCFAIL0_W::new(self)
    }
    #[doc = "Bit 3 - XOSC 1 Clock Failure Detector Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn xoscfail1(&mut self) -> XOSCFAIL1_W<INTENCLR_SPEC, 3> {
        XOSCFAIL1_W::new(self)
    }
    #[doc = "Bit 8 - DFLL Ready Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfllrdy(&mut self) -> DFLLRDY_W<INTENCLR_SPEC, 8> {
        DFLLRDY_W::new(self)
    }
    #[doc = "Bit 9 - DFLL Out Of Bounds Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dflloob(&mut self) -> DFLLOOB_W<INTENCLR_SPEC, 9> {
        DFLLOOB_W::new(self)
    }
    #[doc = "Bit 10 - DFLL Lock Fine Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dflllckf(&mut self) -> DFLLLCKF_W<INTENCLR_SPEC, 10> {
        DFLLLCKF_W::new(self)
    }
    #[doc = "Bit 11 - DFLL Lock Coarse Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dflllckc(&mut self) -> DFLLLCKC_W<INTENCLR_SPEC, 11> {
        DFLLLCKC_W::new(self)
    }
    #[doc = "Bit 12 - DFLL Reference Clock Stopped Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfllrcs(&mut self) -> DFLLRCS_W<INTENCLR_SPEC, 12> {
        DFLLRCS_W::new(self)
    }
    #[doc = "Bit 16 - DPLL0 Lock Rise Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll0lckr(&mut self) -> DPLL0LCKR_W<INTENCLR_SPEC, 16> {
        DPLL0LCKR_W::new(self)
    }
    #[doc = "Bit 17 - DPLL0 Lock Fall Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll0lckf(&mut self) -> DPLL0LCKF_W<INTENCLR_SPEC, 17> {
        DPLL0LCKF_W::new(self)
    }
    #[doc = "Bit 18 - DPLL0 Lock Timeout Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll0lto(&mut self) -> DPLL0LTO_W<INTENCLR_SPEC, 18> {
        DPLL0LTO_W::new(self)
    }
    #[doc = "Bit 19 - DPLL0 Loop Divider Ratio Update Complete Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll0ldrto(&mut self) -> DPLL0LDRTO_W<INTENCLR_SPEC, 19> {
        DPLL0LDRTO_W::new(self)
    }
    #[doc = "Bit 24 - DPLL1 Lock Rise Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll1lckr(&mut self) -> DPLL1LCKR_W<INTENCLR_SPEC, 24> {
        DPLL1LCKR_W::new(self)
    }
    #[doc = "Bit 25 - DPLL1 Lock Fall Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll1lckf(&mut self) -> DPLL1LCKF_W<INTENCLR_SPEC, 25> {
        DPLL1LCKF_W::new(self)
    }
    #[doc = "Bit 26 - DPLL1 Lock Timeout Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll1lto(&mut self) -> DPLL1LTO_W<INTENCLR_SPEC, 26> {
        DPLL1LTO_W::new(self)
    }
    #[doc = "Bit 27 - DPLL1 Loop Divider Ratio Update Complete Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dpll1ldrto(&mut self) -> DPLL1LDRTO_W<INTENCLR_SPEC, 27> {
