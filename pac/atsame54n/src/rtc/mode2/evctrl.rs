...
pub type ALARMEO0_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
#[doc = "Field `ALARMEO1` reader - Alarm 1 Event Output Enable"]
pub type ALARMEO1_R = crate::BitReader<bool>;
#[doc = "Field `ALARMEO1` writer - Alarm 1 Event Output Enable"]
pub type ALARMEO1_W<'a, const O: u8> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alarmeo1(&mut self) -> ALARMEO1_W<9> {
        ALARMEO1_W::new(self)
    }
    #[doc = "Bit 14 - Tamper Event Output Enable"]
    #[inline(always)]
