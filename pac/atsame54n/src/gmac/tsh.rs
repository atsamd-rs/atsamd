...
pub type R = crate::R<TSH_SPEC>;
#[doc = "Register `TSH` writer"]
pub type W = crate::W<TSH_SPEC>;
#[doc = "Field `TCS` reader - Timer Count in Seconds"]
pub type TCS_R = crate::FieldReader<u16>;
#[doc = "Field `TCS` writer - Timer Count in Seconds"]
pub type TCS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcs(&mut self) -> TCS_W<TSH_SPEC, 0> {
        TCS_W::new(self)
    }
