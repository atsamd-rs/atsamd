...
pub type DITHER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PER_DITH4_MODE_SPEC, u8, u8, 4, O>;
#[doc = "Field `PER` reader - Period Value"]
pub type PER_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PER` writer - Period Value"]
pub type PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PER_DITH4_MODE_SPEC, u32, u32, 20, O>;
impl R {
