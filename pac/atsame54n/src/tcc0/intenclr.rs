...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trg(&mut self) -> TRG_W<INTENCLR_SPEC, 1> {
        TRG_W::new(self)
    }
    #[doc = "Bit 2 - Counter Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<INTENCLR_SPEC, 2> {
        CNT_W::new(self)
    }
    #[doc = "Bit 3 - Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn err(&mut self) -> ERR_W<INTENCLR_SPEC, 3> {
        ERR_W::new(self)
    }
    #[doc = "Bit 10 - Non-Recoverable Update Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ufs(&mut self) -> UFS_W<INTENCLR_SPEC, 10> {
        UFS_W::new(self)
    }
    #[doc = "Bit 11 - Non-Recoverable Debug Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfs(&mut self) -> DFS_W<INTENCLR_SPEC, 11> {
        DFS_W::new(self)
    }
    #[doc = "Bit 12 - Recoverable Fault A Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn faulta(&mut self) -> FAULTA_W<INTENCLR_SPEC, 12> {
        FAULTA_W::new(self)
    }
    #[doc = "Bit 13 - Recoverable Fault B Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn faultb(&mut self) -> FAULTB_W<INTENCLR_SPEC, 13> {
        FAULTB_W::new(self)
    }
    #[doc = "Bit 14 - Non-Recoverable Fault 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fault0(&mut self) -> FAULT0_W<INTENCLR_SPEC, 14> {
        FAULT0_W::new(self)
    }
    #[doc = "Bit 15 - Non-Recoverable Fault 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fault1(&mut self) -> FAULT1_W<INTENCLR_SPEC, 15> {
        FAULT1_W::new(self)
    }
    #[doc = "Bit 16 - Match or Capture Channel 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc0(&mut self) -> MC0_W<INTENCLR_SPEC, 16> {
        MC0_W::new(self)
    }
    #[doc = "Bit 17 - Match or Capture Channel 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc1(&mut self) -> MC1_W<INTENCLR_SPEC, 17> {
        MC1_W::new(self)
    }
    #[doc = "Bit 18 - Match or Capture Channel 2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc2(&mut self) -> MC2_W<INTENCLR_SPEC, 18> {
        MC2_W::new(self)
    }
    #[doc = "Bit 19 - Match or Capture Channel 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc3(&mut self) -> MC3_W<INTENCLR_SPEC, 19> {
        MC3_W::new(self)
    }
    #[doc = "Bit 20 - Match or Capture Channel 4 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc4(&mut self) -> MC4_W<INTENCLR_SPEC, 20> {
        MC4_W::new(self)
    }
    #[doc = "Bit 21 - Match or Capture Channel 5 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mc5(&mut self) -> MC5_W<INTENCLR_SPEC, 21> {
        MC5_W::new(self)
    }
