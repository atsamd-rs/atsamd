...
pub type R = crate::R<PERBUF_DITH4_MODE_SPEC>;
#[doc = "Register `PERBUF_DITH4_MODE` writer"]
pub type W = crate::W<PERBUF_DITH4_MODE_SPEC>;
...
pub type DITHERBUF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type PERBUF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 20, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ditherbuf(&mut self) -> DITHERBUF_W<PERBUF_DITH4_MODE_SPEC, 0> {
        DITHERBUF_W::new(self)
    }
    #[doc = "Bits 4:23 - Period Buffer Value"]
    #[inline(always)]
    #[must_use]
    pub fn perbuf(&mut self) -> PERBUF_W<PERBUF_DITH4_MODE_SPEC, 4> {
        PERBUF_W::new(self)
    }
...
#[doc = "Period Buffer\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`perbuf_dith4_mode::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`perbuf_dith4_mode::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
