...
pub type R = crate::R<CCBUF_DITH6_MODE_SPEC>;
#[doc = "Register `CCBUF_DITH6_MODE[%s]` writer"]
pub type W = crate::W<CCBUF_DITH6_MODE_SPEC>;
...
pub type CCBUF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 18, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ditherbuf(&mut self) -> DITHERBUF_W<CCBUF_DITH6_MODE_SPEC, 0> {
        DITHERBUF_W::new(self)
    }
    #[doc = "Bits 6:23 - Channel Compare/Capture Buffer Value"]
    #[inline(always)]
    #[must_use]
    pub fn ccbuf(&mut self) -> CCBUF_W<CCBUF_DITH6_MODE_SPEC, 6> {
        CCBUF_W::new(self)
    }
