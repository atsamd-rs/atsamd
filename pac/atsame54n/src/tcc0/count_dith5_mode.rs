...
pub type R = crate::R<COUNT_DITH5_MODE_SPEC>;
#[doc = "Register `COUNT_DITH5_MODE` writer"]
pub type W = crate::W<COUNT_DITH5_MODE_SPEC>;
#[doc = "Field `COUNT` reader - Counter Value"]
pub type COUNT_R = crate::FieldReader<u32>;
#[doc = "Field `COUNT` writer - Counter Value"]
pub type COUNT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 19, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<COUNT_DITH5_MODE_SPEC, 5> {
        COUNT_W::new(self)
    }
...
#[doc = "Count\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`count_dith5_mode::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`count_dith5_mode::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
