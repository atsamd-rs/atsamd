...
pub type TC6__W<'a, const O: u8> = crate::BitWriter<'a, u32, APBCMASK_SPEC, bool, O>;
#[doc = "Field `TC7_` reader - TC7 APB Clock Enable"]
pub type TC7__R = crate::BitReader<bool>;
#[doc = "Field `TC7_` writer - TC7 APB Clock Enable"]
pub type TC7__W<'a, const O: u8> = crate::BitWriter<'a, u32, APBCMASK_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tc6_(&mut self) -> TC6__W<14> {
        TC6__W::new(self)
    }
    #[doc = "Bit 15 - TC7 APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tc7_(&mut self) -> TC7__W<15> {
        TC7__W::new(self)
    }
    #[doc = "Bit 16 - ADC APB Clock Enable"]
    #[inline(always)]
