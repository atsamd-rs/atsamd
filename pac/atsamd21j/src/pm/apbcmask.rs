...
impl W {
    ...
    #[doc = "Bit 14 - TC6 APB Clock Enable"]
    #[inline(always)]
    pub fn tc6_(&mut self) -> Tc6_W<ApbcmaskSpec> {
        Tc6_W::new(self, 14)
    }
    #[doc = "Bit 15 - TC7 APB Clock Enable"]
    #[inline(always)]
    pub fn tc7_(&mut self) -> Tc7_W<ApbcmaskSpec> {
        Tc7_W::new(self, 15)
    }
    #[doc = "Bit 16 - ADC APB Clock Enable"]
    #[inline(always)]
