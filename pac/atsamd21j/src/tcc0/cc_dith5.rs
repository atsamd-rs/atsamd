...
pub type R = crate::R<CcDith5Spec>;
#[doc = "Register `CC%s_DITH5` writer"]
pub type W = crate::W<CcDith5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dithercy(&mut self) -> DithercyW<CcDith5Spec> {
        DithercyW::new(self, 0)
    }
    #[doc = "Bits 5:23 - Channel Compare/Capture Value"]
    #[inline(always)]
    #[must_use]
    pub fn cc(&mut self) -> CcW<CcDith5Spec> {
        CcW::new(self, 5)
    }
}
