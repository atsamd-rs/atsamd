...
pub type MCKDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type MCKOUTDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsinv(&mut self) -> FSINV_W<CLKCTRL_SPEC, 11> {
        FSINV_W::new(self)
    }
    #[doc = "Bit 12 - Serial Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn scksel(&mut self) -> SCKSEL_W<CLKCTRL_SPEC, 12> {
        SCKSEL_W::new(self)
    }
    #[doc = "Bit 16 - Master Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn mcksel(&mut self) -> MCKSEL_W<CLKCTRL_SPEC, 16> {
        MCKSEL_W::new(self)
    }
    #[doc = "Bit 18 - Master Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mcken(&mut self) -> MCKEN_W<CLKCTRL_SPEC, 18> {
        MCKEN_W::new(self)
    }
    #[doc = "Bits 19:23 - Master Clock Division Factor"]
    #[inline(always)]
    #[must_use]
    pub fn mckdiv(&mut self) -> MCKDIV_W<CLKCTRL_SPEC, 19> {
        MCKDIV_W::new(self)
    }
    #[doc = "Bits 24:28 - Master Clock Output Division Factor"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsoutinv(&mut self) -> FSOUTINV_W<CLKCTRL_SPEC, 29> {
        FSOUTINV_W::new(self)
    }
    #[doc = "Bit 30 - Serial Clock Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn sckoutinv(&mut self) -> SCKOUTINV_W<CLKCTRL_SPEC, 30> {
        SCKOUTINV_W::new(self)
    }
    #[doc = "Bit 31 - Master Clock Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn mckoutinv(&mut self) -> MCKOUTINV_W<CLKCTRL_SPEC, 31> {
