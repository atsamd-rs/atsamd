...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crcchksum(&mut self) -> CRCCHKSUM_W<CRCCHKSUM_SPEC, 0> {
...
#[doc = "CRC Checksum\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`crcchksum::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crcchksum::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
