...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dplllckr(&mut self) -> DPLLLCKR_W<INTENSET_SPEC, 15> {
        DPLLLCKR_W::new(self)
    }
    #[doc = "Bit 16 - DPLL Lock Fall Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dplllckf(&mut self) -> DPLLLCKF_W<INTENSET_SPEC, 16> {
        DPLLLCKF_W::new(self)
    }
    #[doc = "Bit 17 - DPLL Lock Timeout Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dplllto(&mut self) -> DPLLLTO_W<INTENSET_SPEC, 17> {
        DPLLLTO_W::new(self)
    }
