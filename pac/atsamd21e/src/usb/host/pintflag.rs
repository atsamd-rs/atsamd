#[doc = "Reader of register PINTFLAG%s"]
pub type R = crate::R<u8, super::PINTFLAG>;
#[doc = "Writer for register PINTFLAG%s"]
pub type W = crate::W<u8, super::PINTFLAG>;
#[doc = "Register PINTFLAG%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PINTFLAG {
    type Type = u8;
    #[inline(always)]
