...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extint8(&mut self) -> Extint8W<IntenclrSpec> {
        Extint8W::new(self, 8)
    }
    #[doc = "Bit 9 - External Interrupt 9 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint9(&mut self) -> Extint9W<IntenclrSpec> {
        Extint9W::new(self, 9)
    }
    #[doc = "Bit 10 - External Interrupt 10 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint10(&mut self) -> Extint10W<IntenclrSpec> {
        Extint10W::new(self, 10)
    }
    #[doc = "Bit 11 - External Interrupt 11 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint11(&mut self) -> Extint11W<IntenclrSpec> {
        Extint11W::new(self, 11)
    }
    #[doc = "Bit 12 - External Interrupt 12 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint12(&mut self) -> Extint12W<IntenclrSpec> {
        Extint12W::new(self, 12)
    }
    #[doc = "Bit 13 - External Interrupt 13 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint13(&mut self) -> Extint13W<IntenclrSpec> {
        Extint13W::new(self, 13)
    }
    #[doc = "Bit 14 - External Interrupt 14 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint14(&mut self) -> Extint14W<IntenclrSpec> {
        Extint14W::new(self, 14)
    }
    #[doc = "Bit 15 - External Interrupt 15 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint15(&mut self) -> Extint15W<IntenclrSpec> {
