...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extint8(&mut self) -> EXTINT8_W<INTENCLR_SPEC, 8> {
        EXTINT8_W::new(self)
    }
    #[doc = "Bit 9 - External Interrupt 9 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint9(&mut self) -> EXTINT9_W<INTENCLR_SPEC, 9> {
        EXTINT9_W::new(self)
    }
    #[doc = "Bit 10 - External Interrupt 10 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint10(&mut self) -> EXTINT10_W<INTENCLR_SPEC, 10> {
        EXTINT10_W::new(self)
    }
    #[doc = "Bit 11 - External Interrupt 11 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint11(&mut self) -> EXTINT11_W<INTENCLR_SPEC, 11> {
        EXTINT11_W::new(self)
    }
    #[doc = "Bit 12 - External Interrupt 12 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint12(&mut self) -> EXTINT12_W<INTENCLR_SPEC, 12> {
        EXTINT12_W::new(self)
    }
    #[doc = "Bit 13 - External Interrupt 13 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint13(&mut self) -> EXTINT13_W<INTENCLR_SPEC, 13> {
        EXTINT13_W::new(self)
    }
    #[doc = "Bit 14 - External Interrupt 14 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint14(&mut self) -> EXTINT14_W<INTENCLR_SPEC, 14> {
        EXTINT14_W::new(self)
    }
    #[doc = "Bit 15 - External Interrupt 15 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn extint15(&mut self) -> EXTINT15_W<INTENCLR_SPEC, 15> {
        EXTINT15_W::new(self)
    }
