...
pub type PATTBV_R = crate::BitReader<bool>;
#[doc = "Field `PATTBV` writer - Pattern Buffer Valid"]
pub type PATTBV_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
#[doc = "Field `WAVEBV` reader - Wave Buffer Valid"]
pub type WAVEBV_R = crate::BitReader<bool>;
#[doc = "Field `WAVEBV` writer - Wave Buffer Valid"]
pub type WAVEBV_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
...
pub type PERBV_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
...
pub type CCBV0_R = crate::BitReader<bool>;
#[doc = "Field `CCBV0` writer - Compare Channel 0 Buffer Valid"]
pub type CCBV0_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
#[doc = "Field `CCBV1` reader - Compare Channel 1 Buffer Valid"]
pub type CCBV1_R = crate::BitReader<bool>;
#[doc = "Field `CCBV1` writer - Compare Channel 1 Buffer Valid"]
pub type CCBV1_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
#[doc = "Field `CCBV2` reader - Compare Channel 2 Buffer Valid"]
pub type CCBV2_R = crate::BitReader<bool>;
#[doc = "Field `CCBV2` writer - Compare Channel 2 Buffer Valid"]
pub type CCBV2_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
#[doc = "Field `CCBV3` reader - Compare Channel 3 Buffer Valid"]
pub type CCBV3_R = crate::BitReader<bool>;
#[doc = "Field `CCBV3` writer - Compare Channel 3 Buffer Valid"]
pub type CCBV3_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pattbv(&mut self) -> PATTBV_W<5> {
        PATTBV_W::new(self)
    }
    #[doc = "Bit 6 - Wave Buffer Valid"]
    #[inline(always)]
    #[must_use]
    pub fn wavebv(&mut self) -> WAVEBV_W<6> {
        WAVEBV_W::new(self)
    }
    #[doc = "Bit 7 - Period Buffer Valid"]
    #[inline(always)]
    #[must_use]
    pub fn perbv(&mut self) -> PERBV_W<7> {
        PERBV_W::new(self)
    }
    #[doc = "Bit 12 - Recoverable Fault A State"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccbv0(&mut self) -> CCBV0_W<16> {
        CCBV0_W::new(self)
    }
    #[doc = "Bit 17 - Compare Channel 1 Buffer Valid"]
    #[inline(always)]
    #[must_use]
    pub fn ccbv1(&mut self) -> CCBV1_W<17> {
        CCBV1_W::new(self)
    }
    #[doc = "Bit 18 - Compare Channel 2 Buffer Valid"]
    #[inline(always)]
    #[must_use]
    pub fn ccbv2(&mut self) -> CCBV2_W<18> {
        CCBV2_W::new(self)
    }
    #[doc = "Bit 19 - Compare Channel 3 Buffer Valid"]
    #[inline(always)]
    #[must_use]
    pub fn ccbv3(&mut self) -> CCBV3_W<19> {
        CCBV3_W::new(self)
    }
