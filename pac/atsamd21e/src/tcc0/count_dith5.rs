...
pub type R = crate::R<COUNT_DITH5_SPEC>;
#[doc = "Register `COUNT_DITH5` writer"]
pub type W = crate::W<COUNT_DITH5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<COUNT_DITH5_SPEC, 5> {
        COUNT_W::new(self)
    }
...
#[doc = "Count\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`count_dith5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`count_dith5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
