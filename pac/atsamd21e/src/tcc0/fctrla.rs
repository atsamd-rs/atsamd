...
impl CaptureR {
    ...
    pub const fn variant(&self) -> Option<Captureselect> {
        match self.bits {
            0 => Some(Captureselect::Disable),
            1 => Some(Captureselect::Capt),
            2 => Some(Captureselect::Captmin),
            3 => Some(Captureselect::Captmax),
            4 => Some(Captureselect::Locmin),
            5 => Some(Captureselect::Locmax),
            6 => Some(Captureselect::Deriv0),
            _ => None,
        }
    }
    #[doc = "No capture"]
...
pub type CaptureW<'a, REG> = crate::FieldWriter<'a, REG, 3, Captureselect>;
