...
pub type ID_R = crate::FieldReader<u8, IDSELECT_A>;
...
pub type ID_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CLKCTRL_SPEC, u8, IDSELECT_A, 6, O>;
...
pub type GEN_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CLKCTRL_SPEC, u8, GENSELECT_A, 4, O>;
...
pub type CLKEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLKCTRL_SPEC, bool, O>;
#[doc = "Field `WRTLOCK` reader - Write Lock"]
pub type WRTLOCK_R = crate::BitReader<bool>;
#[doc = "Field `WRTLOCK` writer - Write Lock"]
pub type WRTLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLKCTRL_SPEC, bool, O>;
impl R {
