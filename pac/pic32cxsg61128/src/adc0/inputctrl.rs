...
pub enum Muxposselect {
    ...
    Ain15 = 15,
    #[doc = "24: 1/4 Scaled VDDCORE Supply"]
    Scaledvddcore = 24,
    #[doc = "25: 1/4 Scaled VBAT Supply"]
    Scaledvbat = 25,
    #[doc = "26: 1/4 Scaled VDD Supply"]
    Scaledvdd = 26,
...
impl MuxposR {
    ...
    pub const fn variant(&self) -> Option<Muxposselect> {
        match self.bits {
            ...
            24 => Some(Muxposselect::Scaledvddcore),
            25 => Some(Muxposselect::Scaledvbat),
            26 => Some(Muxposselect::Scaledvdd),
            27 => Some(Muxposselect::Bandgap),
            30 => Some(Muxposselect::Dac0),
            _ => None,
        }
    }
    #[doc = "ADC AIN0 Pin"]
    ...
    pub fn is_scaledvddcore(&self) -> bool {
        *self == Muxposselect::Scaledvddcore
    }
    ...
    #[doc = "1/4 Scaled VDD Supply"]
    #[inline(always)]
    pub fn is_scaledvdd(&self) -> bool {
        *self == Muxposselect::Scaledvdd
    }
    #[doc = "Bandgap Voltage"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "1/4 Scaled VDDCORE Supply"]
    #[inline(always)]
    pub fn scaledvddcore(self) -> &'a mut crate::W<REG> {
        self.variant(Muxposselect::Scaledvddcore)
    }
    #[doc = "1/4 Scaled VBAT Supply"]
    #[inline(always)]
    ...
    #[doc = "1/4 Scaled VDD Supply"]
    #[inline(always)]
    pub fn scaledvdd(self) -> &'a mut crate::W<REG> {
        self.variant(Muxposselect::Scaledvdd)
    }
    #[doc = "Bandgap Voltage"]
    #[inline(always)]
    ...
    pub fn dac0(self) -> &'a mut crate::W<REG> {
        self.variant(Muxposselect::Dac0)
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn avss(self) -> &'a mut crate::W<REG> {
        self.variant(Muxnegselect::Avss)
    }
}
