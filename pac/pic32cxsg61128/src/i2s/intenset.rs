...
pub type Rxrdy0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Rxrdy1W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Rxor0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Rxor1W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Txrdy0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Txrdy1W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Txur0W<'a, REG> = crate::BitWriter1S<'a, REG>;
...
pub type Txur1W<'a, REG> = crate::BitWriter1S<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxrdy0(&mut self) -> Rxrdy0W<IntensetSpec> {
        Rxrdy0W::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Ready 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxrdy1(&mut self) -> Rxrdy1W<IntensetSpec> {
        Rxrdy1W::new(self, 1)
    }
    #[doc = "Bit 4 - Receive Overrun 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxor0(&mut self) -> Rxor0W<IntensetSpec> {
        Rxor0W::new(self, 4)
    }
    #[doc = "Bit 5 - Receive Overrun 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxor1(&mut self) -> Rxor1W<IntensetSpec> {
        Rxor1W::new(self, 5)
    }
    #[doc = "Bit 8 - Transmit Ready 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy0(&mut self) -> Txrdy0W<IntensetSpec> {
        Txrdy0W::new(self, 8)
    }
    #[doc = "Bit 9 - Transmit Ready 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy1(&mut self) -> Txrdy1W<IntensetSpec> {
        Txrdy1W::new(self, 9)
    }
    #[doc = "Bit 12 - Transmit Underrun 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txur0(&mut self) -> Txur0W<IntensetSpec> {
        Txur0W::new(self, 12)
    }
    #[doc = "Bit 13 - Transmit Underrun 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txur1(&mut self) -> Txur1W<IntensetSpec> {
        Txur1W::new(self, 13)
    }
}
