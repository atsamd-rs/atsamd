...
impl SlotsizeR {
    ...
    pub const fn variant(&self) -> Slotsizeselect {
        match self.bits {
            0 => Slotsizeselect::Slotsize8,
            1 => Slotsizeselect::Slotsize16,
            2 => Slotsizeselect::Slotsize24,
            3 => Slotsizeselect::Slotsize32,
            _ => unreachable!(),
        }
    }
    #[doc = "8-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn is_slotsize_8(&self) -> bool {
        *self == Slotsizeselect::Slotsize8
    }
    #[doc = "16-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn is_slotsize_16(&self) -> bool {
        *self == Slotsizeselect::Slotsize16
    }
    #[doc = "24-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn is_slotsize_24(&self) -> bool {
        *self == Slotsizeselect::Slotsize24
    }
    #[doc = "32-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn is_slotsize_32(&self) -> bool {
        *self == Slotsizeselect::Slotsize32
    }
}
    ...
    REG::Ux: From<u8>,
{
    #[doc = "8-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn slotsize_8(self) -> &'a mut crate::W<REG> {
        self.variant(Slotsizeselect::Slotsize8)
    }
    #[doc = "16-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn slotsize_16(self) -> &'a mut crate::W<REG> {
        self.variant(Slotsizeselect::Slotsize16)
    }
    #[doc = "24-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn slotsize_24(self) -> &'a mut crate::W<REG> {
        self.variant(Slotsizeselect::Slotsize24)
    }
    #[doc = "32-bit Slot for Clock Unit n"]
    #[inline(always)]
    pub fn slotsize_32(self) -> &'a mut crate::W<REG> {
        self.variant(Slotsizeselect::Slotsize32)
    }
}
