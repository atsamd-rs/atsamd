#[doc = "Register `PMC_SLPWK_SR0` reader"]
pub struct R(crate::R<PMC_SLPWK_SR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PMC_SLPWK_SR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PMC_SLPWK_SR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PMC_SLPWK_SR0_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct PMC_SLPWK_SR0_SPEC;
impl crate::RegisterSpec for PMC_SLPWK_SR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pmc_slpwk_sr0::R](R) reader structure"]
impl crate::Readable for PMC_SLPWK_SR0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PMC_SLPWK_SR0 to value 0"]
impl crate::Resettable for PMC_SLPWK_SR0_SPEC {
    #[inline(always)]
