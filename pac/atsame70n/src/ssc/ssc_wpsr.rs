#[doc = "Register `SSC_WPSR` reader"]
pub struct R(crate::R<SSC_WPSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSC_WPSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSC_WPSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSC_WPSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Write Protection Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ssc_wpsr](index.html) module"]
pub struct SSC_WPSR_SPEC;
impl crate::RegisterSpec for SSC_WPSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ssc_wpsr::R](R) reader structure"]
impl crate::Readable for SSC_WPSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets SSC_WPSR to value 0"]
impl crate::Resettable for SSC_WPSR_SPEC {
    #[inline(always)]
