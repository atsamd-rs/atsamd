#[doc = "Register `GMAC_TIDM3` reader"]
pub struct R(crate::R<GMAC_TIDM3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GMAC_TIDM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GMAC_TIDM3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GMAC_TIDM3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GMAC_TIDM3` writer"]
pub struct W(crate::W<GMAC_TIDM3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GMAC_TIDM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GMAC_TIDM3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GMAC_TIDM3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct GMAC_TIDM3_SPEC;
impl crate::RegisterSpec for GMAC_TIDM3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gmac_tidm3::R](R) reader structure"]
impl crate::Readable for GMAC_TIDM3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gmac_tidm3::W](W) writer structure"]
impl crate::Writable for GMAC_TIDM3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GMAC_TIDM3 to value 0"]
impl crate::Resettable for GMAC_TIDM3_SPEC {
    #[inline(always)]
