#[doc = "Register `GMAC_IDRPQ[%s]` writer"]
pub struct W(crate::W<GMAC_IDRPQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GMAC_IDRPQ_SPEC>;
    #[inline(always)]
...
impl From<crate::W<GMAC_IDRPQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GMAC_IDRPQ_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Interrupt Disable Register Priority Queue (1..5)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gmac_idrpq](index.html) module"]
pub struct GMAC_IDRPQ_SPEC;
impl crate::RegisterSpec for GMAC_IDRPQ_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [gmac_idrpq::W](W) writer structure"]
impl crate::Writable for GMAC_IDRPQ_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GMAC_IDRPQ[%s]
to value 0"]
impl crate::Resettable for GMAC_IDRPQ_SPEC {
    #[inline(always)]
