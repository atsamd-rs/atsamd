#[doc = "Register `GMAC_IER` writer"]
pub struct W(crate::W<GMAC_IER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GMAC_IER_SPEC>;
    #[inline(always)]
...
impl From<crate::W<GMAC_IER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GMAC_IER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct GMAC_IER_SPEC;
impl crate::RegisterSpec for GMAC_IER_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [gmac_ier::W](W) writer structure"]
impl crate::Writable for GMAC_IER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GMAC_IER to value 0"]
impl crate::Resettable for GMAC_IER_SPEC {
    #[inline(always)]
