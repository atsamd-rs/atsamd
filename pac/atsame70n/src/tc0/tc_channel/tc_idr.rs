#[doc = "Register `TC_IDR` writer"]
pub struct W(crate::W<TC_IDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TC_IDR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<TC_IDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TC_IDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Interrupt Disable Register (channel = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tc_idr](index.html) module"]
pub struct TC_IDR_SPEC;
impl crate::RegisterSpec for TC_IDR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [tc_idr::W](W) writer structure"]
impl crate::Writable for TC_IDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TC_IDR to value 0"]
impl crate::Resettable for TC_IDR_SPEC {
    #[inline(always)]
