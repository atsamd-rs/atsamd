#[doc = "Register `USBHS_DEVEPTISR_BLK_MODE[%s]` reader"]
pub struct R(crate::R<USBHS_DEVEPTISR_BLK_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBHS_DEVEPTISR_BLK_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBHS_DEVEPTISR_BLK_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBHS_DEVEPTISR_BLK_MODE_SPEC>) -> Self {
        R(reader)
    }
}
