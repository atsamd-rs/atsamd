#[doc = "Register `USBHS_HSTDMACONTROL` reader"]
pub struct R(crate::R<USBHS_HSTDMACONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBHS_HSTDMACONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBHS_HSTDMACONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBHS_HSTDMACONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBHS_HSTDMACONTROL` writer"]
pub struct W(crate::W<USBHS_HSTDMACONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBHS_HSTDMACONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USBHS_HSTDMACONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBHS_HSTDMACONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Host DMA Channel Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbhs_hstdmacontrol](index.html) module"]
pub struct USBHS_HSTDMACONTROL_SPEC;
impl crate::RegisterSpec for USBHS_HSTDMACONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbhs_hstdmacontrol::R](R) reader structure"]
impl crate::Readable for USBHS_HSTDMACONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usbhs_hstdmacontrol::W](W) writer structure"]
impl crate::Writable for USBHS_HSTDMACONTROL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBHS_HSTDMACONTROL to value 0"]
impl crate::Resettable for USBHS_HSTDMACONTROL_SPEC {
    #[inline(always)]
