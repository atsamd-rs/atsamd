#[doc = "Register `US_IMR_LON_SPI_MODE` reader"]
pub struct R(crate::R<US_IMR_LON_SPI_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<US_IMR_LON_SPI_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<US_IMR_LON_SPI_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<US_IMR_LON_SPI_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [us_imr_lon_spi_mode](index.html) module"]
pub struct US_IMR_LON_SPI_MODE_SPEC;
impl crate::RegisterSpec for US_IMR_LON_SPI_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [us_imr_lon_spi_mode::R](R) reader structure"]
impl crate::Readable for US_IMR_LON_SPI_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets US_IMR_LON_SPI_MODE to value 0"]
impl crate::Resettable for US_IMR_LON_SPI_MODE_SPEC {
    #[inline(always)]
