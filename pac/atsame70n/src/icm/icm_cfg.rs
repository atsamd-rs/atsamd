...
pub struct R(crate::R<ICM_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ICM_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ICM_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ICM_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ICM_CFG` writer"]
pub struct W(crate::W<ICM_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ICM_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ICM_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ICM_CFG_SPEC>) -> Self {
        W(writer)
    }
}
