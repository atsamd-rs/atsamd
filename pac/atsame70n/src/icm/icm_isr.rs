#[doc = "Register `ICM_ISR` reader"]
pub struct R(crate::R<ICM_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ICM_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ICM_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ICM_ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icm_isr](index.html) module"]
pub struct ICM_ISR_SPEC;
impl crate::RegisterSpec for ICM_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [icm_isr::R](R) reader structure"]
impl crate::Readable for ICM_ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ICM_ISR to value 0"]
impl crate::Resettable for ICM_ISR_SPEC {
    #[inline(always)]
