#[doc = "Register `QSPI_IDR` writer"]
pub struct W(crate::W<QSPI_IDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<QSPI_IDR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<QSPI_IDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<QSPI_IDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct QSPI_IDR_SPEC;
impl crate::RegisterSpec for QSPI_IDR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [qspi_idr::W](W) writer structure"]
impl crate::Writable for QSPI_IDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets QSPI_IDR to value 0"]
impl crate::Resettable for QSPI_IDR_SPEC {
    #[inline(always)]
