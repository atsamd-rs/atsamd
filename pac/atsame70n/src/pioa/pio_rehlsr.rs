#[doc = "Register `PIO_REHLSR` writer"]
pub struct W(crate::W<PIO_REHLSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_REHLSR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PIO_REHLSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_REHLSR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Rising Edge/High-Level Select Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_rehlsr](index.html) module"]
pub struct PIO_REHLSR_SPEC;
impl crate::RegisterSpec for PIO_REHLSR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [pio_rehlsr::W](W) writer structure"]
impl crate::Writable for PIO_REHLSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO_REHLSR to value 0"]
impl crate::Resettable for PIO_REHLSR_SPEC {
    #[inline(always)]
