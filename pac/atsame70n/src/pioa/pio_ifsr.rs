#[doc = "Register `PIO_IFSR` reader"]
pub struct R(crate::R<PIO_IFSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO_IFSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO_IFSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO_IFSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Glitch Input Filter Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_ifsr](index.html) module"]
pub struct PIO_IFSR_SPEC;
impl crate::RegisterSpec for PIO_IFSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio_ifsr::R](R) reader structure"]
impl crate::Readable for PIO_IFSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PIO_IFSR to value 0"]
impl crate::Resettable for PIO_IFSR_SPEC {
    #[inline(always)]
