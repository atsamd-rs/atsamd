#[doc = "Register `PIO_SODR` writer"]
pub struct W(crate::W<PIO_SODR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_SODR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PIO_SODR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_SODR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Set Output Data Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_sodr](index.html) module"]
pub struct PIO_SODR_SPEC;
impl crate::RegisterSpec for PIO_SODR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [pio_sodr::W](W) writer structure"]
impl crate::Writable for PIO_SODR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO_SODR to value 0"]
impl crate::Resettable for PIO_SODR_SPEC {
    #[inline(always)]
