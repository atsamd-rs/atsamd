#[doc = "Register `PIO_PUER` writer"]
pub struct W(crate::W<PIO_PUER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_PUER_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PIO_PUER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_PUER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct PIO_PUER_SPEC;
impl crate::RegisterSpec for PIO_PUER_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [pio_puer::W](W) writer structure"]
impl crate::Writable for PIO_PUER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO_PUER to value 0"]
impl crate::Resettable for PIO_PUER_SPEC {
    #[inline(always)]
