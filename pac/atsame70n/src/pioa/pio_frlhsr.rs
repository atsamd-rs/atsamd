#[doc = "Register `PIO_FRLHSR` reader"]
pub struct R(crate::R<PIO_FRLHSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO_FRLHSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO_FRLHSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO_FRLHSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Fall/Rise - Low/High Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_frlhsr](index.html) module"]
pub struct PIO_FRLHSR_SPEC;
impl crate::RegisterSpec for PIO_FRLHSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio_frlhsr::R](R) reader structure"]
impl crate::Readable for PIO_FRLHSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PIO_FRLHSR to value 0"]
impl crate::Resettable for PIO_FRLHSR_SPEC {
    #[inline(always)]
