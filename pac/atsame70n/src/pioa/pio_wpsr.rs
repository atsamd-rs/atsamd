#[doc = "Register `PIO_WPSR` reader"]
pub struct R(crate::R<PIO_WPSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO_WPSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO_WPSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO_WPSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Write Protection Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_wpsr](index.html) module"]
pub struct PIO_WPSR_SPEC;
impl crate::RegisterSpec for PIO_WPSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio_wpsr::R](R) reader structure"]
impl crate::Readable for PIO_WPSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PIO_WPSR to value 0"]
impl crate::Resettable for PIO_WPSR_SPEC {
    #[inline(always)]
