#[doc = "Register `PIO_PPDSR` reader"]
pub struct R(crate::R<PIO_PPDSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO_PPDSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO_PPDSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO_PPDSR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct PIO_PPDSR_SPEC;
impl crate::RegisterSpec for PIO_PPDSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio_ppdsr::R](R) reader structure"]
impl crate::Readable for PIO_PPDSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PIO_PPDSR to value 0"]
impl crate::Resettable for PIO_PPDSR_SPEC {
    #[inline(always)]
