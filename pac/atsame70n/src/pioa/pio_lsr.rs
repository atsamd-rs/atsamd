#[doc = "Register `PIO_LSR` writer"]
pub struct W(crate::W<PIO_LSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_LSR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PIO_LSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_LSR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Level Select Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_lsr](index.html) module"]
pub struct PIO_LSR_SPEC;
impl crate::RegisterSpec for PIO_LSR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [pio_lsr::W](W) writer structure"]
impl crate::Writable for PIO_LSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO_LSR to value 0"]
impl crate::Resettable for PIO_LSR_SPEC {
    #[inline(always)]
