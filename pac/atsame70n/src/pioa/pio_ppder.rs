#[doc = "Register `PIO_PPDER` writer"]
pub struct W(crate::W<PIO_PPDER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_PPDER_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PIO_PPDER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_PPDER_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Pad Pull-down Enable Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio_ppder](index.html) module"]
pub struct PIO_PPDER_SPEC;
impl crate::RegisterSpec for PIO_PPDER_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [pio_ppder::W](W) writer structure"]
impl crate::Writable for PIO_PPDER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO_PPDER to value 0"]
impl crate::Resettable for PIO_PPDER_SPEC {
    #[inline(always)]
