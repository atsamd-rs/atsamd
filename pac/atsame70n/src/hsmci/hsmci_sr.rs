#[doc = "Register `HSMCI_SR` reader"]
pub struct R(crate::R<HSMCI_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSMCI_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSMCI_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSMCI_SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsmci_sr](index.html) module"]
pub struct HSMCI_SR_SPEC;
impl crate::RegisterSpec for HSMCI_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsmci_sr::R](R) reader structure"]
impl crate::Readable for HSMCI_SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HSMCI_SR to value 0"]
impl crate::Resettable for HSMCI_SR_SPEC {
    #[inline(always)]
