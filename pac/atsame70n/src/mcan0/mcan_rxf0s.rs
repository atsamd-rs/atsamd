...
pub struct R(crate::R<MCAN_RXF0S_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCAN_RXF0S_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCAN_RXF0S_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCAN_RXF0S_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Receive FIFO 0 Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mcan_rxf0s](index.html) module"]
pub struct MCAN_RXF0S_SPEC;
impl crate::RegisterSpec for MCAN_RXF0S_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mcan_rxf0s::R](R) reader structure"]
impl crate::Readable for MCAN_RXF0S_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MCAN_RXF0S to value 0"]
impl crate::Resettable for MCAN_RXF0S_SPEC {
    #[inline(always)]
