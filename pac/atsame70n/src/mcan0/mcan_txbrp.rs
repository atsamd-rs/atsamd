...
pub struct R(crate::R<MCAN_TXBRP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCAN_TXBRP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCAN_TXBRP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCAN_TXBRP_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Transmit Buffer Request Pending Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mcan_txbrp](index.html) module"]
pub struct MCAN_TXBRP_SPEC;
impl crate::RegisterSpec for MCAN_TXBRP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mcan_txbrp::R](R) reader structure"]
impl crate::Readable for MCAN_TXBRP_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MCAN_TXBRP to value 0"]
impl crate::Resettable for MCAN_TXBRP_SPEC {
    #[inline(always)]
