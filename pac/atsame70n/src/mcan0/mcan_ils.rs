...
pub struct R(crate::R<MCAN_ILS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCAN_ILS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCAN_ILS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCAN_ILS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MCAN_ILS` writer"]
pub struct W(crate::W<MCAN_ILS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MCAN_ILS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MCAN_ILS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MCAN_ILS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct MCAN_ILS_SPEC;
impl crate::RegisterSpec for MCAN_ILS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mcan_ils::R](R) reader structure"]
impl crate::Readable for MCAN_ILS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mcan_ils::W](W) writer structure"]
impl crate::Writable for MCAN_ILS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MCAN_ILS to value 0"]
impl crate::Resettable for MCAN_ILS_SPEC {
    #[inline(always)]
