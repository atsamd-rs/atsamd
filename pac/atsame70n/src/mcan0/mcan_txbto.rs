...
pub struct R(crate::R<MCAN_TXBTO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCAN_TXBTO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCAN_TXBTO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCAN_TXBTO_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Transmit Buffer Transmission Occurred Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mcan_txbto](index.html) module"]
pub struct MCAN_TXBTO_SPEC;
impl crate::RegisterSpec for MCAN_TXBTO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mcan_txbto::R](R) reader structure"]
impl crate::Readable for MCAN_TXBTO_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MCAN_TXBTO to value 0"]
impl crate::Resettable for MCAN_TXBTO_SPEC {
    #[inline(always)]
