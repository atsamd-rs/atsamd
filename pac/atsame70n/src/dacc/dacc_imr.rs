#[doc = "Register `DACC_IMR` reader"]
pub struct R(crate::R<DACC_IMR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DACC_IMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DACC_IMR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DACC_IMR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dacc_imr](index.html) module"]
pub struct DACC_IMR_SPEC;
impl crate::RegisterSpec for DACC_IMR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dacc_imr::R](R) reader structure"]
impl crate::Readable for DACC_IMR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DACC_IMR to value 0"]
impl crate::Resettable for DACC_IMR_SPEC {
    #[inline(always)]
