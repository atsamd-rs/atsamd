...
pub type Per0W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per1W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per2W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per3W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per4W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per5W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per6W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Per7W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Cmp0W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Cmp1W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type Cmp2W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp2(&mut self) -> Cmp2W<IntenclrSpec> {
        Cmp2W::new(self, 10)
    }
    #[doc = "Bit 11 - Compare 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3(&mut self) -> Cmp3W<IntenclrSpec> {
        Cmp3W::new(self, 11)
    }
    #[doc = "Bit 14 - Tamper Enable"]
    #[inline(always)]
...
impl crate::Writable for IntenclrSpec {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0xcfff;
}
