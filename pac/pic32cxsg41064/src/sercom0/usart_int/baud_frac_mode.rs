...
pub type R = crate::R<BaudFracModeSpec>;
#[doc = "Register `BAUD_FRAC_MODE` writer"]
pub type W = crate::W<BaudFracModeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn baud(&mut self) -> BaudW<BaudFracModeSpec> {
        BaudW::new(self, 0)
    }
    #[doc = "Bits 13:15 - Fractional Part"]
    #[inline(always)]
    #[must_use]
    pub fn fp(&mut self) -> FpW<BaudFracModeSpec> {
        FpW::new(self, 13)
    }
}
...
pub struct BaudFracModeSpec;
impl crate::RegisterSpec for BaudFracModeSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`baud_frac_mode::R`](R) reader structure"]
impl crate::Readable for BaudFracModeSpec {}
#[doc = "`write(|w| ..)` method takes [`baud_frac_mode::W`](W) writer structure"]
impl crate::Writable for BaudFracModeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets BAUD_FRAC_MODE to value 0"]
impl crate::Resettable for BaudFracModeSpec {
