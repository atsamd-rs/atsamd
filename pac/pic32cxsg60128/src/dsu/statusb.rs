...
#[doc = "Field `CEHL` reader - Chip Erase Hard Locked"]
pub type CehlR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Protected"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Chip Erase Hard Locked"]
    #[inline(always)]
    pub fn cehl(&self) -> CehlR {
        CehlR::new(((self.bits >> 6) & 1) != 0)
    }
}
