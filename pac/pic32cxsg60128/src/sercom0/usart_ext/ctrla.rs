...
impl TxpoR {
    ...
    pub const fn variant(&self) -> Option<Txposelect> {
        match self.bits {
            0 => Some(Txposelect::Pad0),
            2 => Some(Txposelect::Pad2),
            3 => Some(Txposelect::Pad3),
            _ => None,
        }
    }
    #[doc = "PAD\\[0\\]
