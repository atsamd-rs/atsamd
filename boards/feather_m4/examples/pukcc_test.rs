...
fn main() -> ! {
    ...
    loop {
        ...
        serial_writeln!(
            "Test vector: {} samples",
            exp_mod::MODULUS_PRIV_EXPONENT_CYPHER_TUPLES.len()
        );
        for (i, (modulus, private_exponent, reference_signature)) in
            exp_mod::MODULUS_PRIV_EXPONENT_CYPHER_TUPLES
                .iter()
                .enumerate()
        {
...
mod exp_mod {
    ...
    pub const MODULUS_PRIV_EXPONENT_CYPHER_TUPLES: [(&'static [u8], &'static [u8], &'static [u8]);
        8] = [
        (
            &[
...
mod ecdsa {
    pub const PRIVATE_KEY: [u8; 32] = [
        ...
        0x33, 0x3e, 0x26, 0x8a, 0xc, 0x94, 0x4c, 0xde, 0x56, 0xff, 0xb5, 0x27, 0xb7, 0x7f, 0xa6,
        0x11, 0xc,
    ];
    ...
    pub const PUBLIC_KEY: [u8; 64] = [
        ...
        0x9d, 0x84, 0xa, 0xca, 0xd, 0xdd, 0xe8, 0xf5, 0xc8, 0x2f, 0x84, 0x10, 0xb5, 0x62, 0xc2,
        0x3a, 0x46, 0xde, 0xcd, 0xcb, 0x59, 0x6e, 0x40, 0x2, 0xcb, 0x10, 0xc6, 0x2f, 0x5b, 0x5e,
        0xb5, 0xf2, 0xa7, 0xd7,
    ];
    ...
    pub const K_SIGNATURE_PAIRS: [([u8; 32], [u8; 64]); 10] = [
        (
            [
                0x48, 0x4a, 0x19, 0x66, 0x2, 0x50, 0xe, 0xf2, 0xd0, 0xbe, 0x90, 0x84, 0x23, 0x8e,
                0x45, 0x9, 0x6c, 0x23, 0x8b, 0x1b, 0x74, 0xa8, 0x6b, 0x17, 0x46, 0x62, 0x75, 0xd2,
                0xfa, 0x27, 0x7e, 0x1b,
            ],
            [
                0x21, 0xea, 0xf, 0xfd, 0x35, 0x43, 0xdf, 0x7a, 0xdb, 0xf5, 0x4f, 0x88, 0xe, 0x9d,
                0xd2, 0xa7, 0x26, 0x4f, 0x2f, 0x96, 0xe9, 0x85, 0x5f, 0x67, 0xa9, 0x82, 0x46, 0xfe,
                0x46, 0xef, 0x92, 0x9d, 0x3c, 0x59, 0x7c, 0x22, 0x4b, 0x69, 0x80, 0xf7, 0x1, 0x46,
                0x9, 0xce, 0x13, 0x59, 0xfd, 0x21, 0xd1, 0x45, 0x65, 0xfb, 0xb0, 0x82, 0x1b, 0x91,
        ...
        (
            [
                0x91, 0xda, 0x2c, 0xea, 0x22, 0xc3, 0x8, 0x44, 0x5c, 0x1, 0xe, 0x2b, 0x0, 0x74,
                0x44, 0x5, 0x14, 0x50, 0x25, 0x92, 0xb3, 0xde, 0xe9, 0xcd, 0xb0, 0x67, 0x25, 0x10,
                0x26, 0x8a, 0x66, 0xb6,
            ],
            [
                0x89, 0xaa, 0x32, 0x68, 0x8, 0xbf, 0x3f, 0xd8, 0xbb, 0x13, 0xc5, 0x51, 0xa6, 0xe,
                0x13, 0x3f, 0xb5, 0x6f, 0x96, 0xcd, 0x7d, 0x9f, 0xe7, 0xd4, 0x17, 0xef, 0xad, 0x93,
                0x14, 0xed, 0x4f, 0xf, 0xdb, 0x34, 0xc1, 0xc3, 0xf4, 0xc9, 0x11, 0x9e, 0xd7, 0xe7,
                0x23, 0xbc, 0xd3, 0x5c, 0x73, 0x57, 0xd5, 0x74, 0x75, 0x90, 0xaf, 0x4e, 0x60, 0x47,
                0x57, 0xe0, 0x16, 0xc2, 0xd, 0x9e, 0xce, 0x44,
            ],
        ),
        (
            [
                0x3d, 0x3d, 0x65, 0x81, 0x9d, 0xc3, 0xd1, 0x23, 0xde, 0x2d, 0xe0, 0x92, 0x99, 0x7d,
                0xb, 0xb5, 0xab, 0x93, 0x2, 0xa, 0x8b, 0xd, 0x37, 0xe3, 0xe0, 0xf, 0xf7, 0x91,
                0x60, 0x39, 0xf4, 0x97,
            ],
            [
        ...
        (
            [
                ...
                0xe8, 0x58, 0x19, 0x74, 0x9, 0xa, 0x75, 0xa3, 0xfb, 0xbd, 0x38, 0x97, 0xba, 0x92,
                0xb3, 0x87, 0x81, 0x88,
            ],
            [
        ...
        (
            [
                ...
                0x82, 0xe7, 0xde, 0x42, 0x37, 0x8d, 0xb9, 0x97, 0xa6, 0x5e, 0x4b, 0xe, 0xc8, 0xaa,
                0x9, 0xbc, 0xee, 0xac,
            ],
            [
                0x69, 0xc1, 0x7c, 0x3f, 0xaa, 0x6, 0xa, 0x0, 0xd, 0xdf, 0x8, 0x1d, 0x38, 0xe3,
                0xa8, 0xc5, 0xe7, 0xa5, 0x80, 0xbd, 0x48, 0x27, 0xdf, 0x20, 0x12, 0x36, 0x9f, 0x4b,
                0xfd, 0x59, 0x2a, 0x92, 0x95, 0x71, 0xa3, 0xc, 0x58, 0x7d, 0x6a, 0x6d, 0x7b, 0x1f,
