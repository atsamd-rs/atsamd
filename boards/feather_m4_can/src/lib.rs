...
//! Board support crate for Adafruit's Feather M4 CAN Express,
//! an ATSAME51-based board with CAN, in a Feather form factor.
...
hal::bsp_pins!(
    ...
    PB12 {
        /// PB12: TCAN1051H on-board CAN device, S pin (S for silent)
        aliases: {
            PushPullOutput: Tcan1051S
        }
    }
    PB13 {
        /// PB13: enables the boost converter that supplies the TCAN1051H
        aliases: {
            PushPullOutput: BoostEn
        }
    }
    PB14 {
        /// PB14: TCAN1051H on-board CAN device transmit pin
        aliases: {
            AlternateH: Tcan1051Tx
        }
    }
    PB15 {
        /// PB15: TCAN1051H on-board CAN device receive pin
        aliases: {
            AlternateH: Tcan1051Rx
        }
    }
    PB16 {
        /// Pin 1, UART tx
