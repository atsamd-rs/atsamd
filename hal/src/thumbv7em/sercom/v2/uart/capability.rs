...
pub enum Error {
    ...
    CollisionDetected,
    /// Transmitter empty. This is only used it the UART peripheral is set to
    /// LIN master mode. Not used in this module.
    TransmitterEmpty,
    ///Maximum number of NACK repetitions or retransmissions is met in ISO7816
    /// T=0 mode. Not used in this module.
    MaxRepetitions,
}
...
impl TryFrom<Status> for () {
    ...
    fn try_from(errors: Status) -> Result<(), Error> {
        ...
        } else if errors.contains(Status::TXE) {
            Err(TransmitterEmpty)
...
impl From<Error> for Status {
    ...
    fn from(err: Error) -> Self {
        ...
        match err {
            ...
            TransmitterEmpty => Status::TXE,
            MaxRepetitions => Status::ITER,
        }
    }
}
