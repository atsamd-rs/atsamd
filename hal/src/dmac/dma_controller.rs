...
//! [`DmaController::new`] method. It will consume the
...
#[hal_cfg(any("dmac-d11", "dmac-d21"))]
use crate::pac::Pm;
use crate::{pac::Dmac, typelevel::NoneT};

#[hal_cfg("dmac-d5x")]
type DmacAhbClk = crate::clock::v2::ahb::AhbClk<crate::clock::v2::types::Dmac>;
...
impl<T> DmaController<T> {
    ...
    #[inline]
    fn disable_and_reset(dmac: &mut Dmac) {
