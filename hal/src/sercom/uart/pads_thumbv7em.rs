    ...
    (RX, TX, RTS, CTS): ShareIoSet,
{
    ...
    where
        Id: GetPad<S>,
        (Pad<S, Id>, TX, RTS, CTS): ShareIoSet,
    ...
    where
        Id: GetPad<S>,
        (RX, Pad<S, Id>, RTS, CTS): ShareIoSet,
        Pin<Id, <Id as GetPad<S>>::PinMode>: IsPad,
    {
        Pads {
            sercom: self.sercom,
